...
Analysis::Analysis(D3PDSelector * inst)
{
  ...
  TString configfile="CutsLS.config";
  TEnv *params = new TEnv ("config_file");
  
  params->ReadFile (configfile, kEnvChange);
  
  
  ControlTTbar = params->GetValue ("RunParameters.ControlRegionTTbar", 0);
  ControlZmumu = params->GetValue ("RunParameters.ControlRegionZmumu", 0);
  RemoveZWindow = params->GetValue ("RunParameters.RemoveZWindow", 0);
  debug = params->GetValue ("Cuts.debug", 2);
  REALDATA = params->GetValue ("RunParameters.REALDATA",0);
  NJETMIN = params->GetValue ("Cuts.NJETMIN", 0);
  JETPT1_CUT = params->GetValue ("Cuts.JETPT1_CUT", 0);
  JETPT2_CUT = params->GetValue ("Cuts.JETPT2_CUT", 0);
  JETPT3_CUT = params->GetValue ("Cuts.JETPT3_CUT", 0);
  JETPT4_CUT = params->GetValue ("Cuts.JETPT4_CUT", 0);
  NJETMIN = params->GetValue ("Cuts.NJETMIN", 0);
  NELEMIN = params->GetValue ("Cuts.NELEMIN", 0);
  NMUOMIN = params->GetValue ("Cuts.NMUOMIN", 0);
  NMUGMIN = params->GetValue ("Cuts.", 0);
  NTAUMIN = params->GetValue ("Cuts.NMUGMIN", 0);
  NLEPMIN = params->GetValue ("Cuts.NLEPMIN", 0);
  NSLOWMUOMIN = params->GetValue ("Cuts.NSLOWMUOMIN", 0);
  ETMISS_CUT = params->GetValue ("Cuts.ETMISS_CUT", 0);
  ZMASSMIN_CUT = params->GetValue ("Cuts.ZMASSMIN_CUT", 70000.0);
  ZMASSMAX_CUT = params->GetValue ("Cuts.ZMASSMAX_CUT", 110000.0);
  HTALLJETSALLLEPTONS_CUT = params->GetValue ("Cuts.HTALLJETSALLLEPTONS_CUT", 0.0);
  HTALLJETS_CUT = params->GetValue ("Cuts.HTALLJETS_CUT", 0.0);
  HTALLLEPTONS_CUT = params->GetValue ("Cuts.HTALLLEPTONS_CUT", 0.0);
  LOWBETAMUON1ETA_CUT = params->GetValue ("Cuts.LOWBETAMUON1ETA_CUT", 3.0);
  REQUIRE_NEUTRALINO= params->GetValue ("Cuts.RequireNeutralino",0);
	
  cout << "Printing cut parameters" << endl;
  cout << " NJETMIN: " << NJETMIN<< endl;
  cout << " JETPT1_CUT: " << JETPT1_CUT << endl;
  cout << " JETPT2_CUT: " << JETPT2_CUT << endl;
  cout << " JETPT3_CUT: " << JETPT3_CUT << endl;
  cout << " JETPT4_CUT: " << JETPT4_CUT << endl;
  cout << " NJETMIN: " << NJETMIN << endl;
  cout << " NELEMIN: " << NELEMIN << endl;
  cout << " NMUOMIN: " << NMUOMIN << endl;
  cout << " NMUGMIN: " << NMUGMIN << endl;
  cout << " NTAUMIN: " << NTAUMIN << endl;
  cout << " NLEPMIN: " << NLEPMIN << endl;
  cout << " NSLOWMUOMIN: " << NSLOWMUOMIN << endl;
  cout << " ETMISS_CUT: " << ETMISS_CUT << endl;
  cout << " ZMASSMIN_CUT: " << ZMASSMIN_CUT << endl;
  cout << " ZMASSMAX_CUT: " << ZMASSMAX_CUT << endl;
  cout << " HTALLJETSALLLEPTONS_CUT: " << HTALLJETSALLLEPTONS_CUT << endl;
  cout << " HTALLJETS_CUT: " << HTALLJETS_CUT << endl;
  cout << " HTALLLEPTONS_CUT: " << HTALLLEPTONS_CUT << endl;
  cout << " LOWBETAMUON1ETA_CUT: " << LOWBETAMUON1ETA_CUT << endl;
  ...
  hCutFlow = new TH1D("hCutFlow", "cut flow", 20, 0.0, 20.0);
  hCutFlowIndividual = new TH1D("hCutFlowIndividual", "cut flow Individual", 20, 0.0, 20.0);
	
  hJet1pT = new TH1D("hJet1pT", "jet1pT", 200, 0, 1200);
  hJet2pT = new TH1D("hJet2pT", "jet2pT", 200, 0, 1200);
  hJet3pT = new TH1D("hJet3pT", "jet3pT", 200, 0, 800);
  hJet4pT = new TH1D("hJet4pT", "jet4pT", 200, 0, 400);
  ...
  hJet1Mass = new TH1D("hJet1Mass", "jet1Mass", 200, 0.0, 200.0);
  hJet2Mass = new TH1D("hJet2Mass", "jet2Mass", 200, 0.0, 100.0);
  hJet3Mass = new TH1D("hJet3Mass", "jet3Mass", 200, 0.0, 60.0);
  hJet4Mass = new TH1D("hJet4Mass", "jet4Mass", 200, 1000.0, 40.0);
  ...
  //Jet derived variables Ht, H  
  hHtJet1Jet2 = new TH1D("hHtJet1Jet2", "HtJet1Jet2", 200, 0.0, 2000.0);
  hHtAllJets = new TH1D("hHtAllJets", " HtAllJets", 200, 0.0, 3800.0);
  hHtAllObjects = new TH1D("hHtAllObjects", "HtAllObjects", 200, 0.0, 4200.0);
  hHJet1Jet2 = new TH1D("hHJet1Jet2", "HJet1Jet2", 200, 0.0, 2000.0);
  hHAllJets = new TH1D("hHAllJets", "HAllJets", 200, 0.0, 5000.0);
  hHAllObjects = new TH1D("hHAllObjects", "HAllObjects", 200, 0.0, 5000.0);
  hHtLepton1Lepton2 = new TH1D("hHtLepton1Lepton2", "Histo name hHtLepton1Lepton2", 200, 0.0, 2000.0);
  hHtAllLeptons = new TH1D("hHtAllLeptons", "Histo name hHtAllLeptons", 200, 0.0, 2000.0);
  hHtAllJetsAllLeptons = new TH1D("hHtAllJetsAllLeptons", " HtAllJetsAllLeptons", 200, 0.0, 5000.0);
  ...
  hRecoEleInvMass = new TH1D("hRecoEleInvMass","Reco Mass first 2 ee ",100,0,2);
  
  hElectron1pT = new TH1D("hElectron1pT", "Electron 1 pT", 200, 0, 1000);
  hElectron2pT = new TH1D("hElectron2pT", "Electron 2 pT", 200, 0, 600);
  hElectron3pT = new TH1D("hElectron3pT", "Electron 3 pT", 200, 0, 600);
  ...
  hElectron1Mass = new TH1D("hElectron1Mass", "Electron 1 Mass", 200, 0.0, 0.15);
  hElectron2Mass = new TH1D("hElectron2Mass", "Electron 2 Mass", 200, 0.0, 0.150);
  hElectron3Mass = new TH1D("hElectron3Mass", "Electron 3 Mass", 200, 0.0, 0.150);
  ...
  hMuon1pT = new TH1D("hMuon1pT", "Muon 1 pT", 200, 0, 1000);
  hMuon2pT = new TH1D("hMuon2pT", "Muon 2 pT", 200, 0, 600);
  hMuon3pT = new TH1D("hMuon3pT", "Muon 3 pT", 200, 0, 600);
  ...
  hMuon1Mass = new TH1D("hMuon1Mass", "Muon 1 Mass", 100, 0.0, 0.20);
  hMuon2Mass = new TH1D("hMuon2Mass", "Muon 2 Mass", 100, 0.0, 0.20);
  hMuon3Mass = new TH1D("hMuon3Mass", "Muon 3 Mass", 100, 0.0, 0.20);
  ...
  hMuLowBetaMuon1pT = new TH1D("hMuLowBetaMuon1pT", "LowBetaMuon 1 pT", 200, 0, 1000);
  hMuLowBetaMuon2pT = new TH1D("hMuLowBetaMuon2pT", "LowBetaMuon 2 pT", 200, 0, 600);
  hMuLowBetaMuon3pT = new TH1D("hMuLowBetaMuon3pT", "LowBetaMuon 3 pT", 200, 0, 600);
  
  hMuLowBetaMuon1EtaAbs = new TH1D("hMuLowBetaMuon1EtaAbs", "|LowBetaMuon 1 Eta|", 100,0.0, 3.0);
  ...
  hMuLowBetaMuon1Mass = new TH1D("hMuLowBetaMuon1Mass", "LowBetaMuon 1 Mass", 100, 0.0, 400.0);
  hMuLowBetaMuon2Mass = new TH1D("hMuLowBetaMuon2Mass", "LowBetaMuon 2 Mass", 100, 0.0, 300.0);
  hMuLowBetaMuon3Mass = new TH1D("hMuLowBetaMuon3Mass", "LowBetaMuon 3 Mass", 100, 0.0, 300.0);
	
  hMuLowBetaMuon1MassOrig = new TH1D("hMuLowBetaMuon1MassOrig", "LowBetaMuon 1 Mass from LowBetaMuon orig", 100, 0.0, 300.0);
  hMuLowBetaMuon2MassOrig = new TH1D("hMuLowBetaMuon2MassOrig", "LowBetaMuon 2 Mass from LowBetaMuon orig", 100, 0.0, 300.0);
  hMuLowBetaMuon3MassOrig = new TH1D("hMuLowBetaMuon3MassOrig", "LowBetaMuon 3 Mass from LowBetaMuon orig", 100, 0.0, 300.0);
  
  hMuLowBetaMuon1Beta = new TH1D("hMuLowBetaMuon1Beta", "LowBetaMuon 1 Beta", 100, -1.0, 2.0);
  hMuLowBetaMuon2Beta = new TH1D("hMuLowBetaMuon2Beta", "LowBetaMuon 2 Beta", 100, -1.0, 2.0);
  hMuLowBetaMuon3Beta = new TH1D("hMuLowBetaMuon3Beta", "LowBetaMuon 3 Beta", 100, -1.0, 2.0);

  hMuLowBetaMuon1TileBeta = new TH1D("hMuLowBetaMuon1TileBeta", "LowBetaMuon 1 Tile Beta", 100, -1.0, 2.0);
  hMuLowBetaMuon1TruthBeta = new TH1D("hMuLowBetaMuon1TruthBeta", "LowBetaMuon 1 Truth Beta", 100, -1.0, 2.0);
  hMuLowBetaMuon1DeltaBeta = new TH1D("hMuLowBetaMuon1DeltaBeta", "LowBetaMuon 1 Delta Beta", 100, -3.0, 3.0);  
  hMuLowBetaMuon1DeltaTileBeta = new TH1D("hMuLowBetaMuon1DeltaTileBeta", "LowBetaMuon 1 Delta Tile Beta", 100, -3.0, 3.0);
	
  hdRMuLowBetaMuon1MuLowBetaMuon2 = new TH1D("hdRMuLowBetaMuon1MuLowBetaMuon2", "Histo dR RMuLowBetaMuon1 MuLowBetaMuon2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1MuLowBetaMuon3 = new TH1D("hdRMuLowBetaMuon1MuLowBetaMuon3", "Histo dR RMuLowBetaMuon1 MuLowBetaMuon3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2MuLowBetaMuon3 = new TH1D("hdRMuLowBetaMuon2MuLowBetaMuon3", "Histo dR RMuLowBetaMuon2 MuLowBetaMuon3", 100, 0.0, 7.0);

  hdRMuLowBetaMuon1Muon1 = new TH1D("hdRMuLowBetaMuon1Muon1", "Histo  hdRMuLowBetaMuon1Muon1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Muon2 = new TH1D("hdRMuLowBetaMuon1Muon2", "Histo  hdRMuLowBetaMuon1Muon2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Muon3 = new TH1D("hdRMuLowBetaMuon1Muon3", "Histo  hdRMuLowBetaMuon1Muon3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Electron1 = new TH1D("hdRMuLowBetaMuon1Electron1", "Histo  hdRMuLowBetaMuon1Electron1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Electron2 = new TH1D("hdRMuLowBetaMuon1Electron2", "Histo  hdRMuLowBetaMuon1Electron2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Electron3 = new TH1D("hdRMuLowBetaMuon1Electron3", "Histo  hdRMuLowBetaMuon1Electron3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Jet1 = new TH1D("hdRMuLowBetaMuon1Jet1", "Histo  hdRMuLowBetaMuon1Jet1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Jet2 = new TH1D("hdRMuLowBetaMuon1Jet2", "Histo  hdRMuLowBetaMuon1Jet2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon1Jet3 = new TH1D("hdRMuLowBetaMuon1Jet3", "Histo  hdRMuLowBetaMuon1Jet3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Muon1 = new TH1D("hdRMuLowBetaMuon2Muon1", "Histo  hdRMuLowBetaMuon2Muon1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Muon2 = new TH1D("hdRMuLowBetaMuon2Muon2", "Histo  hdRMuLowBetaMuon2Muon2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Muon3 = new TH1D("hdRMuLowBetaMuon2Muon3", "Histo  hdRMuLowBetaMuon2Muon3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Electron1 = new TH1D("hdRMuLowBetaMuon2Electron1", "Histo  hdRMuLowBetaMuon2Electron1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Electron2 = new TH1D("hdRMuLowBetaMuon2Electron2", "Histo  hdRMuLowBetaMuon2Electron2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Electron3 = new TH1D("hdRMuLowBetaMuon2Electron3", "Histo  hdRMuLowBetaMuon2Electron3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Jet1 = new TH1D("hdRMuLowBetaMuon2Jet1", "Histo  hdRMuLowBetaMuon2Jet1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Jet2 = new TH1D("hdRMuLowBetaMuon2Jet2", "Histo  hdRMuLowBetaMuon2Jet2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon2Jet3 = new TH1D("hdRMuLowBetaMuon2Jet3", "Histo  hdRMuLowBetaMuon2Jet3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Muon1 = new TH1D("hdRMuLowBetaMuon3Muon1", "Histo  hdRMuLowBetaMuon3Muon1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Muon2 = new TH1D("hdRMuLowBetaMuon3Muon2", "Histo  hdRMuLowBetaMuon3Muon2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Muon3 = new TH1D("hdRMuLowBetaMuon3Muon3", "Histo  hdRMuLowBetaMuon3Muon3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Electron1 = new TH1D("hdRMuLowBetaMuon3Electron1", "Histo  hdRMuLowBetaMuon3Electron1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Electron2 = new TH1D("hdRMuLowBetaMuon3Electron2", "Histo  hdRMuLowBetaMuon3Electron2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Electron3 = new TH1D("hdRMuLowBetaMuon3Electron3", "Histo  hdRMuLowBetaMuon3Electron3", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Jet1 = new TH1D("hdRMuLowBetaMuon3Jet1", "Histo  hdRMuLowBetaMuon3Jet1", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Jet2 = new TH1D("hdRMuLowBetaMuon3Jet2", "Histo  hdRMuLowBetaMuon3Jet2", 100, 0.0, 7.0);
  hdRMuLowBetaMuon3Jet3 = new TH1D("hdRMuLowBetaMuon3Jet3", "Histo  hdRMuLowBetaMuon3Jet3", 100, 0.0, 7.0);
  ...
  hMuGirlMuon1pT = new TH1D("hMuGirlMuon1pT", "MuGirlMuon 1 pT", 200, 0, 1000);
  hMuGirlMuon2pT = new TH1D("hMuGirlMuon2pT", "MuGirlMuon 2 pT", 200, 0, 600);
  hMuGirlMuon3pT = new TH1D("hMuGirlMuon3pT", "MuGirlMuon 3 pT", 200, 0, 600);
  ...
  hMuGirlMuon1Mass = new TH1D("hMuGirlMuon1Mass", "MuGirlMuon 1 Mass", 100, 0.0, 0.170);
  hMuGirlMuon2Mass = new TH1D("hMuGirlMuon2Mass", "MuGirlMuon 2 Mass", 100, 0.0, 0.170);
  hMuGirlMuon3Mass = new TH1D("hMuGirlMuon3Mass", "MuGirlMuon 3 Mass", 100, 0.0, 0.170);
  ...
  // MET quantities
  hMET = new TH1D("hMET","Missing ET",200,0.0,500);
  ...
  lshRecoJJInvMass = new TH1D("lshRecoJJInvMass","Reco Mass 3rd and 4th Jets ",100,0.0,300);
  lshRecoBBInvMass = new TH1D("lshRecoBBInvMass","Reco Mass 2 b-jets ",100,0.0,100);
  lshRecoEleInvMass = new TH1D("lshRecoEleInvMass","Reco Mass first 2 ee ",100,0.,1000);
  hdRMinDilep = new TH1D("hdRMinDilep","Dilepton min dR",100,0.0,7.0);
  hdRMinDilepInvMass= new TH1D("hdRMinDilepInvMass","Dilepton Inv Mass with min dR",100,0.0,800.0);
  h2dInvMassMindRDilep= new TH2D("h2dInvMassMindRDilep","Dilepton min dR vs Inv Mass",100,0.0,800.0,100,0.0,7.0);
  ...
  hNeutralinoMass=new TH1D("hNeutralinoMass","Neutralino Mass Reco",100,80.0,2000.0);
  hNeutralino2Mass=new TH1D("hNeutralino2Mass","Neutralino Mass Reco",100,80.0,2000.0);
  hSquarkMass=new TH1D("hSquarkMass","Squark Mass Reco",100,80.0,2500.0);
  hGluinoMass=new TH1D("hGluinoMass","Gluino Mass Reco",100,80.0,3000.0);
	
  hNeutralinoTransverseMass=new TH1D("hNeutralinoTransverseMass","Neutralino TransverseMass Reco",100,80.0,2000000.0);
  hNeutralino2TransverseMass=new TH1D("hNeutralino2TransverseMass","Neutralino TransverseMass Reco",100,80.0,2000000.0);
  hSquarkTransverseMass=new TH1D("hSquarkTransverseMass","Squark TransverseMass Reco",100,80.0,2500000.0);
  hGluinoTransverseMass=new TH1D("hGluinoTransverseMass","Gluino TransverseMass Reco",100,80.0,3000000.0);
	
  hdRMinLeptons = new TH1D("hdRMinLeptons","Leptons min dR",100,0.,7.0);
  hMassMindRLeptons = new TH1D("hMassMindRLeptons","Leptons min dR Mass",100,0.0,1000000.0);
  hMassCloseZLeptons = new TH1D("hMassCloseZLeptons","Leptons pair with the closest mass of 80 GeV",100,0.0,1000000.0);
  hMassCloseZMuons = new TH1D("hMassCloseZMuons","Muon pair with the closest mass of 80 GeV",100,0.0,1000000.0);
  h2dMassMindRLeptons = new TH2D("h2dMassMindRLeptons","min dR Leptons vs Inv Mass",100,0.0,600000.0,100,0.0,7.0);
  hdRLeptons = new TH1D("hdRLeptons","Leptons dR",100,0.,7.0);
  hMassdRLeptons = new TH1D("hMassdRLeptons","Leptons dR Mass",100,0.0,900000.0);
  h2dMassdRLeptons = new TH2D("h2dMassdRLeptons","dR Leptons vs Inv Mass",100,0.0,500000.0,100,0.0,7.0);
  //bTagInfo
  ...
  // TRIGGER STUDIES
  //  h_EF_mu22_medium = new TH1D("h_EF_mu22_medium", "Histo  h_EF_mu22_medium", 10, 0.0, 10.0);
  h_EF_mu18_medium = new TH1D("h_EF_mu18_medium", "Histo  h_EF_mu18_medium", 10, 0.0, 10.0);
//  h_EF_2mu10_loose = new TH1D("h_EF_2mu10_loose", "Histo  h_EF_2mu10_loose", 10, 0.0, 10.0);
//  h_EF_mu40_slow = new TH1D("h_EF_mu40_slow", "Histo  h_EF_mu40_slow", 10, 0.0, 10.0);
//  h_EF_mu40_slow_medium = new TH1D("h_EF_mu40_slow_medium", "Histo  h_EF_mu40_slow_medium", 10, 0.0, 10.0);
//  h_EF_mu40_slow_outOfTime_medium = new TH1D("h_EF_mu40_slow_outOfTime_medium", "Histo  h_EF_mu40_slow_outOfTime_medium", 10, 0.0, 10.0);
//  h_EF_mu40_slow_empty = new TH1D("h_EF_mu40_slow_empty", "Histo  h_EF_mu40_slow_empty", 10, 0.0, 10.0);
//  h_EF_mu40_slow_outOfTime = new TH1D("h_EF_mu40_slow_outOfTime", "Histo  h_EF_mu40_slow_outOfTime", 10, 0.0, 10.0);
  h_trigger_muOR = new TH1D("h_trigger_muOR", "Histo  h_trigger_muOR", 15, 0.0, 15.0);
  h_trigger_muOR_BC = new TH1D("h_trigger_muOR_BC", "Histo  h_trigger_muOR_BC", 15, 0.0, 15.0);
  ...
  BarCodeHistoMuon = new TH1D("BarCodeHistoMuon","Muons in the same container ",20,0,20);
  
  hHtJet1Jet2_HtLepton1Lepton2 = new TH2D("hHtJet1Jet2_HtLepton1Lepton2", "HtLepton1Lepton2 vs HtJet1Jet2", 200, 0.0, 2000.0, 200, 0.0, 2000.0);
  hHtJet1Jet2_Met = new TH2D("hHtJet1Jet2_Met", "Met vs HtJet1Jet2", 200, 0.0, 2000.0,100,0.0,400.0);
  hHtJet1Jet2_LowBetaMuonBeta = new TH2D("hHtJet1Jet2_LowBetaMuonBeta", "LowBetaMuonBeta vs HtJet1Jet2", 200, 0.0, 2000.0,100,0.0,1.0);
  hHtJet1Jet2_NJets = new TH2D("hHtJet1Jet2_NJets", "NJets vs HtJet1Jet2", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtJet1Jet2_NLeptons = new TH2D("hHtJet1Jet2_NLeptons", "NLeptons vs HtJet1Jet2", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtJet1Jet2_LowBetaMuon1Eta = new TH2D("hHtJet1Jet2_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs HtJet1Jet2", 200, 0.0, 2000.0,100,0.0,3.0);
  hHtJet1Jet2_LowBetaMuon1pT = new TH2D("hHtJet1Jet2_LowBetaMuon1pT", "LowBetaMuon1pT vs HtJet1Jet2", 200, 0.0, 2000.0,100,0.0,800.0);
  hHtJet1Jet2_LowBetaMuon1MassBeta = new TH2D("hHtJet1Jet2_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs HtJet1Jet2", 200, 0.0, 2000.0,100,50.0,200.0);
  hHtJet1Jet2_GluinoMass = new TH2D("hHtJet1Jet2_GluinoMass", "GluinoMass vs HtJet1Jet2", 200, 0.0, 2000.0,200,80.0,2200.0);
  
  hHtLepton1Lepton2_Met = new TH2D("hHtLepton1Lepton2_Met", "Met vs HtLepton1Lepton2", 200, 0.0, 2000.0,100,0.0,400.0);
  hHtLepton1Lepton2_LowBetaMuonBeta = new TH2D("hHtLepton1Lepton2_LowBetaMuonBeta", "LowBetaMuonBeta vs HtLepton1Lepton2", 200, 0.0, 2000.0,100,0.0,1.0);
  hHtLepton1Lepton2_NJets = new TH2D("hHtLepton1Lepton2_NJets", "NJets vs HtLepton1Lepton2", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtLepton1Lepton2_NLeptons = new TH2D("hHtLepton1Lepton2_NLeptons", "NLeptons vs HtLepton1Lepton2", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtLepton1Lepton2_LowBetaMuon1Eta = new TH2D("hHtLepton1Lepton2_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs HtLepton1Lepton2", 200, 0.0, 2000.0,100,0.0,3.0);
  hHtLepton1Lepton2_LowBetaMuon1pT = new TH2D("hHtLepton1Lepton2_LowBetaMuon1pT", "LowBetaMuon1pT vs HtLepton1Lepton2", 200, 0.0, 2000.0,100,0.0,800.0);
  hHtLepton1Lepton2_LowBetaMuon1MassBeta = new TH2D("hHtLepton1Lepton2_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs HtLepton1Lepton2", 200, 0.0, 2000.0,100,50.0,200.0);
  hHtLepton1Lepton2_GluinoMass = new TH2D("hHtLepton1Lepton2_GluinoMass", "GluinoMass vs HtLepton1Lepton2", 200, 0.0, 2000.0,200,80.0,2200.0);
  
  hHtAllJets_HtAllLeptons = new TH2D("hHtAllJets_HtAllLeptons", "HtAllLeptons vs HtAllJets", 200, 0.0, 3800.0, 200, 0.0, 2000.0);
  hHtAllJets_Met = new TH2D("hHtAllJets_Met", "Met vs HtAllJets", 200, 0.0, 3800.0,100,0.0,400.0);
  hHtAllJets_LowBetaMuonBeta = new TH2D("hHtAllJets_LowBetaMuonBeta", "LowBetaMuonBeta vs HtAllJets", 200, 0.0, 3800.0,100,0.0,1.0);
  hHtAllJets_NJets = new TH2D("hHtAllJets_NJets", "NJets vs HtAllJets", 200, 0.0, 3800.0,10,0.0,10.0);
  hHtAllJets_NLeptons = new TH2D("hHtAllJets_NLeptons", "NLeptons vs HtAllJets", 200, 0.0, 3800.0,10,0.0,10.0);
  hHtAllJets_LowBetaMuon1Eta = new TH2D("hHtAllJets_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs HtAllJets", 200, 0.0, 3800.0,100,0.0,3.0);
  hHtAllJets_LowBetaMuon1pT = new TH2D("hHtAllJets_LowBetaMuon1pT", "LowBetaMuon1pT vs HtAllJets", 200, 0.0, 3800.0,100,0.0,800.0);
  hHtAllJets_LowBetaMuon1MassBeta = new TH2D("hHtAllJets_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs HtAllJets", 200, 0.0, 3800.0,100,50.0,200.0);
  hHtAllJets_GluinoMass = new TH2D("hHtAllJets_GluinoMass", "GluinoMass vs HtAllJets", 200, 0.0, 3800.0,200,80.0,2200.0);
  
  hHtAllLeptons_Met = new TH2D("hHtAllLeptons_Met", "Met vs HtAllLeptons", 200, 0.0, 2000.0,100,0.0,400.0);
  hHtAllLeptons_LowBetaMuonBeta = new TH2D("hHtAllLeptons_LowBetaMuonBeta", "LowBetaMuonBeta vs HtAllLeptons", 200, 0.0, 2000.0,100,0.0,1.0);
  hHtAllLeptons_NJets = new TH2D("hHtAllLeptons_NJets", "NJets vs HtAllLeptons", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtAllLeptons_NLeptons = new TH2D("hHtAllLeptons_NLeptons", "NLeptons vs HtAllLeptons", 200, 0.0, 2000.0,10,0.0,10.0);
  hHtAllLeptons_LowBetaMuon1Eta = new TH2D("hHtAllLeptons_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs HtAllLeptons", 200, 0.0, 2000.0,100,0.0,3.0);
  hHtAllLeptons_LowBetaMuon1pT = new TH2D("hHtAllLeptons_LowBetaMuon1pT", "LowBetaMuon1pT vs HtAllLeptons", 200, 0.0, 2000.0,100,0.0,800.0);
  hHtAllLeptons_LowBetaMuon1MassBeta = new TH2D("hHtAllLeptons_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs HtAllLeptons", 200, 0.0, 2000.0,100,50.0,200.0);
  hHtAllLeptons_GluinoMass = new TH2D("hHtAllLeptons_GluinoMass", "GluinoMass vs HtAllLeptons", 200, 0.0, 2000.0,200,80.0,2200.0);

  hHtAllJetsAllLeptons_Met = new TH2D("hHtAllJetsAllLeptons_Met", "Met vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,100,0.0,400.0);
  hHtAllJetsAllLeptons_LowBetaMuonBeta = new TH2D("hHtAllJetsAllLeptons_LowBetaMuonBeta", "LowBetaMuonBeta vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,100,0.0,1.0);
  hHtAllJetsAllLeptons_NJets = new TH2D("hHtAllJetsAllLeptons_NJets", "NJets vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,10,0.0,10.0);
  hHtAllJetsAllLeptons_NLeptons = new TH2D("hHtAllJetsAllLeptons_NLeptons", "NLeptons vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,10,0.0,10.0);
  hHtAllJetsAllLeptons_LowBetaMuon1Eta = new TH2D("hHtAllJetsAllLeptons_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,100,0.0,3.0);
  hHtAllJetsAllLeptons_LowBetaMuon1pT = new TH2D("hHtAllJetsAllLeptons_LowBetaMuon1pT", "LowBetaMuon1pT vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,100,0.0,800.0);
  hHtAllJetsAllLeptons_LowBetaMuon1MassBeta = new TH2D("hHtAllJetsAllLeptons_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,100,50.0,200.0);
  hHtAllJetsAllLeptons_GluinoMass = new TH2D("hHtAllJetsAllLeptons_GluinoMass", "GluinoMass vs HtAllJetsAllLeptons", 200, 0.0, 5000.0,200,80.0,2200.0);
  
  hJet1Pt_Met = new TH2D("hJet1Pt_Met", "Met vs Jet1 pT", 100,0.0,600.0,100,0.0,400.0);
  hJet1Pt_LowBetaMuonBeta = new TH2D("hJet1Pt_LowBetaMuonBeta", "LowBetaMuonBeta vs Jet1 pT", 100,0.0,600.0,100,0.0,1.0);
  hJet1Pt_NJets = new TH2D("hJet1Pt_NJets", "NJets vs Jet1 pT", 100,0.0,600.0,10,0.0,10.0);
  hJet1Pt_NLeptons = new TH2D("hJet1Pt_NLeptons", "NLeptons vs Jet1 pT", 100,0.0,600.0,10,0.0,10.0);
  hJet1Pt_LowBetaMuon1Eta = new TH2D("hJet1Pt_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs Jet1 pT", 100,0.0,600.0,100,0.0,3.0);
  hJet1Pt_LowBetaMuon1pT = new TH2D("hJet1Pt_LowBetaMuon1pT", "LowBetaMuon1pT vs Jet1 pT", 100,0.0,600.0,100,0.0,800.0);
  hJet1Pt_LowBetaMuon1MassBeta = new TH2D("hJet1Pt_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs Jet1 pT", 100,0.0,600.0,100,50.0,200.0);
  hJet1Pt_GluinoMass = new TH2D("hJet1Pt_GluinoMass", "GluinoMass vs Jet1 pT", 100,0.0,600.0,200,80.0,2200.0);
  
  hMet_LowBetaMuonBeta = new TH2D("hMet_LowBetaMuonBeta", "LowBetaMuonBeta vs MET ", 100,0.0,400.0,100,0.0,1.0);
  hMet_NJets = new TH2D("hMet_NJets", "NJets vs MET ", 100,0.0,400.0,10,0.0,10.0);
  hMet_NLeptons = new TH2D("hMet_NLeptons", "NLeptons vs MET ", 100,0.0,400.0,10,0.0,10.0);
  hMet_LowBetaMuon1Eta = new TH2D("hMet_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs MET ", 100,0.0,400.0,100,0.0,3.0);
  hMet_LowBetaMuon1pT = new TH2D("hMet_LowBetaMuon1pT", "LowBetaMuon1pT vs MET ", 100,0.0,400.0,100,0.0,800.0);
  hMet_LowBetaMuon1MassBeta = new TH2D("hMet_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs MET ", 100,0.0,400.0,100,50.0,200.0);
  hMet_GluinoMass = new TH2D("hMet_GluinoMass", "GluinoMass vs MET ", 100,0.0,400.0,200,80.0,2200.0);
  
  hLowBetaMuonBeta_NJets = new TH2D("hLowBetaMuonBeta_NJets", "NJets vs LowBetaMuonBeta ", 100,0.0,1.0,10,0.0,10.0);
  hLowBetaMuonBeta_NLeptons = new TH2D("hLowBetaMuonBeta_NLeptons", "NLeptons vs LowBetaMuonBeta ", 100,0.0,1.0,10,0.0,10.0);
  hLowBetaMuonBeta_LowBetaMuon1Eta = new TH2D("hLowBetaMuonBeta_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs LowBetaMuonBeta ", 100,0.0,1.0,100,0.0,3.0);
  hLowBetaMuonBeta_LowBetaMuon1pT = new TH2D("hLowBetaMuonBeta_LowBetaMuon1pT", "LowBetaMuon1pT vs LowBetaMuonBeta ", 100,0.0,1.0,100,0.0,800.0);
  hLowBetaMuonBeta_LowBetaMuon1MassBeta = new TH2D("hLowBetaMuonBeta_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs LowBetaMuonBeta ", 100,0.0,1.0,100,50.0,200.0);
  hLowBetaMuonBeta_GluinoMass = new TH2D("hLowBetaMuonBeta_GluinoMass", "GluinoMass vs LowBetaMuonBeta ", 100,0.0,1.0,200,80.0,2200.0);
  
  hNJets_NLeptons = new TH2D("hNJets_NLeptons", "NLeptons vs NJets ", 10,0.0,10.0,10,0.0,10.0);
  hNJets_LowBetaMuon1Eta = new TH2D("hNJets_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs NJets ", 10,0.0,10.0,100,0.0,3.0);
  hNJets_LowBetaMuon1pT = new TH2D("hNJets_LowBetaMuon1pT", "LowBetaMuon1pT vs NJets ", 10,0.0,10.0,100,0.0,800.0);
  hNJets_LowBetaMuon1MassBeta = new TH2D("hNJets_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs NJets ", 10,0.0,10.0,100,50.0,200.0);
  hNJets_GluinoMass = new TH2D("hNJets_GluinoMass", "GluinoMass vs NJets ", 10,0.0,10.0,200,80.0,2200.0);

  hNLeptons_LowBetaMuon1Eta = new TH2D("hNLeptons_LowBetaMuon1Eta", "abs |LowBetaMuon1Eta| vs NLeptons", 10,0.0,10.0,100,0.0,3.0);
  hNLeptons_LowBetaMuon1pT = new TH2D("hNLeptons_LowBetaMuon1pT", "LowBetaMuon1pT vs NLeptons", 10,0.0,10.0,100,0.0,800.0);
  hNLeptons_LowBetaMuon1MassBeta = new TH2D("hNLeptons_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs NLeptons", 10,0.0,10.0,100,50.0,200.0);
  hNLeptons_GluinoMass = new TH2D("hNLeptons_GluinoMass", "GluinoMass vs NLeptons", 10,0.0,10.0,200,80.0,2200.0);

  hLowBetaMuon1Eta_LowBetaMuon1pT = new TH2D("hLowBetaMuon1Eta_LowBetaMuon1pT", "LowBetaMuon1pT vs abs |LowBetaMuon1Eta|", 100,0.0,3.0,100,0.0,800.0);
  hLowBetaMuon1Eta_LowBetaMuon1MassBeta = new TH2D("hLowBetaMuon1Eta_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs abs |LowBetaMuon1Eta|", 100,0.0,3.0,100,50.0,200.0);
  hLowBetaMuon1Eta_GluinoMass = new TH2D("hLowBetaMuon1Eta_GluinoMass", "GluinoMass vs abs |LowBetaMuon1Eta|", 100,0.0,3.0,200,80.0,2200.0);
  hLowBetaMuon1pT_LowBetaMuon1MassBeta = new TH2D("hLowBetaMuon1pT_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs LowBetaMuon1pT", 100,0.0,800.0,100,50.0,200.0);
  hLowBetaMuon1pT_GluinoMass = new TH2D("hLowBetaMuon1pT_GluinoMass", "GluinoMass vs LowBetaMuon1pT", 100,0.0,800.0,200,80.0,2200.0);
  hLowBetaMuon1MassBeta_GluinoMass = new TH2D("hLowBetaMuon1MassBeta_GluinoMass", "GluinoMass vs LowBetaMuon1MassBeta", 100,50.0,200.0,200,80.0,2200.0);

  hMassCloseZMuons_HtAllJetsAllLeptons = new TH2D("hMassCloseZMuons_HtAllJetsAllLeptons", "HtAllJetsAllLeptons vs MassCloseZMuons", 100, 0.0, 600000.0, 200, 0.0, 5000.0);
  hMassCloseZMuons_HtAllJets = new TH2D("hMassCloseZMuons_HtAllJets", "HtAllJets vs MassCloseZMuons", 100, 0.0, 600000.0, 200, 0.0, 3800.0);
  hMassCloseZMuons_HtAllLeptons = new TH2D("hMassCloseZMuons_HtAllLeptons", "HtAllLeptons vs MassCloseZMuons", 100, 0.0, 600000.0, 200, 0.0, 2000.0);
  hMassCloseZMuons_Met = new TH2D("hMassCloseZMuons_Met", "Met vs MassCloseZMuons", 100, 0.0, 600000.0, 200, 0.0, 400.0);
  hMassCloseZMuons_LowBetaMuonBeta = new TH2D("hMassCloseZMuons_LowBetaMuonBeta", "LowBetaMuonBeta vs MassCloseZMuons", 100, 0.0, 600000.0, 100, 0.0, 1.0);
  hMassCloseZMuons_NJets = new TH2D("hMassCloseZMuons_NJets", "NJets vs MassCloseZMuons", 100, 0.0, 600000.0, 10, 0.0, 10.0);
  hMassCloseZMuons_NLeptons = new TH2D("hMassCloseZMuons_NLeptons", "NLeptons vs MassCloseZMuons", 100, 0.0, 600000.0, 10, 0.0, 10.0);
  hMassCloseZMuons_LowBetaMuon1Eta = new TH2D("hMassCloseZMuons_LowBetaMuon1Eta", "LowBetaMuon1Eta vs MassCloseZMuons", 100, 0.0, 600000.0, 100, 0.0, 3.0);
  hMassCloseZMuons_LowBetaMuon1pT = new TH2D("hMassCloseZMuons_LowBetaMuon1pT", "LowBetaMuon1pT vs MassCloseZMuons", 100, 0.0, 600000.0, 100, 0.0, 800.0);
  hMassCloseZMuons_LowBetaMuon1MassBeta = new TH2D("hMassCloseZMuons_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs MassCloseZMuons", 100, 0.0, 600000.0, 100, 50.0, 200.0);
  hMassCloseZMuons_GluinoMass = new TH2D("hMassCloseZMuons_GluinoMass", "GluinoMass vs MassCloseZMuons", 100, 0.0, 600000.0, 200, 80.0, 2200.0);

  hRequireNeutralino_HtAllJetsAllLeptons = new TH2D("hRequireNeutralino_HtAllJetsAllLeptons", "HtAllJetsAllLeptons vs RequireNeutralino", 2, 0.0, 2.0, 200, 0.0, 5000.0);
  hRequireNeutralino_HtAllJets = new TH2D("hRequireNeutralino_HtAllJets", "HtAllJets vs RequireNeutralino", 2, 0.0, 2.0,200, 0.0, 3800.0);
  hRequireNeutralino_HtAllLeptons = new TH2D("hRequireNeutralino_HtAllLeptons", "HtAllLeptons vs RequireNeutralino", 2, 0.0, 2.0, 200, 0.0, 2000.0);
  hRequireNeutralino_Met = new TH2D("hRequireNeutralino_Met", "Met vs RequireNeutralino", 2, 0.0, 2.0, 200, 0.0, 400.0);
  hRequireNeutralino_LowBetaMuonBeta = new TH2D("hRequireNeutralino_LowBetaMuonBeta", "LowBetaMuonBeta vs RequireNeutralino", 2, 0.0, 2.0, 100, 0.0, 1.0);
  hRequireNeutralino_NJets = new TH2D("hRequireNeutralino_NJets", "NJets vs RequireNeutralino", 2, 0.0, 2.0, 10, 0.0, 10.0);
  hRequireNeutralino_NLeptons = new TH2D("hRequireNeutralino_NLeptons", "NLeptons vs RequireNeutralino", 2, 0.0, 2.0, 10, 0.0, 10.0);
  hRequireNeutralino_LowBetaMuon1Eta = new TH2D("hRequireNeutralino_LowBetaMuon1Eta", "LowBetaMuon1Eta vs RequireNeutralino", 2, 0.0, 2.0, 100, 0.0, 3.0);
  hRequireNeutralino_LowBetaMuon1pT = new TH2D("hRequireNeutralino_LowBetaMuon1pT", "LowBetaMuon1pT vs RequireNeutralino", 2, 0.0, 2.0, 100, 0.0, 800.0);
  hRequireNeutralino_LowBetaMuon1MassBeta = new TH2D("hRequireNeutralino_LowBetaMuon1MassBeta", "LowBetaMuon1MassBeta vs RequireNeutralino", 2, 0.0, 2.0, 100, 50.0, 200.0);
  hRequireNeutralino_GluinoMass = new TH2D("hRequireNeutralino_GluinoMass", "GluinoMass vs RequireNeutralino", 2, 0.0, 2.0, 200, 80.0, 2200.0);
  hRequireNeutralino_MassCloseZMuons = new TH2D("hRequireNeutralino_MassCloseZMuons", "MassCloseZMuons vs RequireNeutralino", 2, 0.0, 2.0, 100, 0.0, 600000.0);
  ...
  m_sel->AddTObject(hCutFlowIndividual);
  ...
  m_sel->AddTObject(hHtJet1Jet2);
  m_sel->AddTObject(hHtAllJets);
  m_sel->AddTObject(hHtAllObjects);
  m_sel->AddTObject(hHJet1Jet2);
  m_sel->AddTObject(hHAllJets);
  m_sel->AddTObject(hHAllObjects);
  m_sel->AddTObject(hHtLepton1Lepton2);
  m_sel->AddTObject(hHtAllLeptons);
  m_sel->AddTObject(hHtAllJetsAllLeptons);
  ...
  m_sel->AddTObject(hMuLowBetaMuon1EtaAbs);
  ...
  m_sel->AddTObject(hMuLowBetaMuon1MassOrig);
  m_sel->AddTObject(hMuLowBetaMuon2MassOrig);
  m_sel->AddTObject(hMuLowBetaMuon3MassOrig);
  m_sel->AddTObject(hMuLowBetaMuon1Beta);
  m_sel->AddTObject(hMuLowBetaMuon2Beta);
  m_sel->AddTObject(hMuLowBetaMuon3Beta);
  m_sel->AddTObject(hMuLowBetaMuon1TileBeta);
  m_sel->AddTObject(hMuLowBetaMuon1TruthBeta);
  m_sel->AddTObject(hMuLowBetaMuon1DeltaBeta);
  m_sel->AddTObject(hMuLowBetaMuon1DeltaTileBeta);
  m_sel->AddTObject(hdRMuLowBetaMuon1Muon1);
  m_sel->AddTObject(hdRMuLowBetaMuon1Muon2);
  m_sel->AddTObject(hdRMuLowBetaMuon1Muon3);

  m_sel->AddTObject(hdRMuLowBetaMuon1MuLowBetaMuon2);
  m_sel->AddTObject(hdRMuLowBetaMuon1MuLowBetaMuon3);
  m_sel->AddTObject(hdRMuLowBetaMuon2MuLowBetaMuon3);

  m_sel->AddTObject(hdRMuLowBetaMuon1Electron1);
  m_sel->AddTObject(hdRMuLowBetaMuon1Electron2);
  m_sel->AddTObject(hdRMuLowBetaMuon1Electron3);
  m_sel->AddTObject(hdRMuLowBetaMuon1Jet1);
  m_sel->AddTObject(hdRMuLowBetaMuon1Jet2);
  m_sel->AddTObject(hdRMuLowBetaMuon1Jet3);
  m_sel->AddTObject(hdRMuLowBetaMuon2Muon1);
  m_sel->AddTObject(hdRMuLowBetaMuon2Muon2);
  m_sel->AddTObject(hdRMuLowBetaMuon2Muon3);
  m_sel->AddTObject(hdRMuLowBetaMuon2Electron1);
  m_sel->AddTObject(hdRMuLowBetaMuon2Electron2);
  m_sel->AddTObject(hdRMuLowBetaMuon2Electron3);
  m_sel->AddTObject(hdRMuLowBetaMuon2Jet1);
  m_sel->AddTObject(hdRMuLowBetaMuon2Jet2);
  m_sel->AddTObject(hdRMuLowBetaMuon2Jet3);
  m_sel->AddTObject(hdRMuLowBetaMuon3Muon1);
  m_sel->AddTObject(hdRMuLowBetaMuon3Muon2);
  m_sel->AddTObject(hdRMuLowBetaMuon3Muon3);
  m_sel->AddTObject(hdRMuLowBetaMuon3Electron1);
  m_sel->AddTObject(hdRMuLowBetaMuon3Electron2);
  m_sel->AddTObject(hdRMuLowBetaMuon3Electron3);
  m_sel->AddTObject(hdRMuLowBetaMuon3Jet1);
  m_sel->AddTObject(hdRMuLowBetaMuon3Jet2);
  m_sel->AddTObject(hdRMuLowBetaMuon3Jet3);
 ...
 //  m_sel->AddTObject(hTau3Mass);
  ...
  m_sel->AddTObject(hNeutralinoMass);
  m_sel->AddTObject(hNeutralino2Mass);
  m_sel->AddTObject(hSquarkMass);
  m_sel->AddTObject(hGluinoMass);
	
  m_sel->AddTObject(hNeutralinoTransverseMass);
  m_sel->AddTObject(hNeutralino2TransverseMass);
  m_sel->AddTObject(hSquarkTransverseMass);
  m_sel->AddTObject(hGluinoTransverseMass);
	
  m_sel->AddTObject(hdRMinLeptons);
  m_sel->AddTObject(hMassCloseZLeptons);
  m_sel->AddTObject(hMassCloseZMuons);
  ...
  //TRIGGER STUDIES
  //  m_sel->AddTObject(h_EF_mu22_medium);
  m_sel->AddTObject(h_EF_mu18_medium);
//  m_sel->AddTObject(h_EF_2mu10_loose);
//  m_sel->AddTObject(h_EF_mu40_slow);
//  m_sel->AddTObject(h_EF_mu40_slow_medium);
//  m_sel->AddTObject(h_EF_mu40_slow_outOfTime_medium);
//  m_sel->AddTObject(h_EF_mu40_slow_empty);
//  m_sel->AddTObject(h_EF_mu40_slow_outOfTime);
  m_sel->AddTObject(h_trigger_muOR);
  m_sel->AddTObject(h_trigger_muOR_BC);
  ...
  m_sel->AddTObject(BarCodeHistoMuon);
	
  m_sel->AddTObject(hHtJet1Jet2_HtLepton1Lepton2);
  m_sel->AddTObject(hHtJet1Jet2_Met);
  m_sel->AddTObject(hHtJet1Jet2_LowBetaMuonBeta);
  m_sel->AddTObject(hHtJet1Jet2_NJets);
  m_sel->AddTObject(hHtJet1Jet2_NLeptons);
  m_sel->AddTObject(hHtJet1Jet2_LowBetaMuon1Eta);
  m_sel->AddTObject(hHtJet1Jet2_LowBetaMuon1pT);
  m_sel->AddTObject(hHtJet1Jet2_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hHtJet1Jet2_GluinoMass);
  m_sel->AddTObject(hHtLepton1Lepton2_Met);
  m_sel->AddTObject(hHtLepton1Lepton2_LowBetaMuonBeta);
  m_sel->AddTObject(hHtLepton1Lepton2_NJets);
  m_sel->AddTObject(hHtLepton1Lepton2_NLeptons);
  m_sel->AddTObject(hHtLepton1Lepton2_LowBetaMuon1Eta);
  m_sel->AddTObject(hHtLepton1Lepton2_LowBetaMuon1pT);
  m_sel->AddTObject(hHtLepton1Lepton2_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hHtLepton1Lepton2_GluinoMass);
  m_sel->AddTObject(hHtAllJets_Met);
  m_sel->AddTObject(hHtAllJets_HtAllLeptons);
  m_sel->AddTObject(hHtAllJets_LowBetaMuonBeta);
  m_sel->AddTObject(hHtAllJets_NJets);
  m_sel->AddTObject(hHtAllJets_NLeptons);
  m_sel->AddTObject(hHtAllJets_LowBetaMuon1Eta);
  m_sel->AddTObject(hHtAllJets_LowBetaMuon1pT);
  m_sel->AddTObject(hHtAllJets_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hHtAllJets_GluinoMass);
  m_sel->AddTObject(hHtAllLeptons_Met);
  m_sel->AddTObject(hHtAllLeptons_LowBetaMuonBeta);
  m_sel->AddTObject(hHtAllLeptons_NJets);
  m_sel->AddTObject(hHtAllLeptons_NLeptons);
  m_sel->AddTObject(hHtAllLeptons_LowBetaMuon1Eta);
  m_sel->AddTObject(hHtAllLeptons_LowBetaMuon1pT);
  m_sel->AddTObject(hHtAllLeptons_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hHtAllLeptons_GluinoMass);
  m_sel->AddTObject(hHtAllJetsAllLeptons_Met);
  m_sel->AddTObject(hHtAllJetsAllLeptons_LowBetaMuonBeta);
  m_sel->AddTObject(hHtAllJetsAllLeptons_NJets);
  m_sel->AddTObject(hHtAllJetsAllLeptons_NLeptons);
  m_sel->AddTObject(hHtAllJetsAllLeptons_LowBetaMuon1Eta);
  m_sel->AddTObject(hHtAllJetsAllLeptons_LowBetaMuon1pT);
  m_sel->AddTObject(hHtAllJetsAllLeptons_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hHtAllJetsAllLeptons_GluinoMass);

  m_sel->AddTObject(hJet1Pt_Met);
  m_sel->AddTObject(hJet1Pt_LowBetaMuonBeta);
  m_sel->AddTObject(hJet1Pt_NJets);
  m_sel->AddTObject(hJet1Pt_NLeptons);
  m_sel->AddTObject(hJet1Pt_LowBetaMuon1Eta);
  m_sel->AddTObject(hJet1Pt_LowBetaMuon1pT);
  m_sel->AddTObject(hJet1Pt_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hJet1Pt_GluinoMass);
  m_sel->AddTObject(hMet_LowBetaMuonBeta);
  m_sel->AddTObject(hMet_NJets);
  m_sel->AddTObject(hMet_NLeptons);
  m_sel->AddTObject(hMet_LowBetaMuon1Eta);
  m_sel->AddTObject(hMet_LowBetaMuon1pT);
  m_sel->AddTObject(hMet_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hMet_GluinoMass);
  m_sel->AddTObject(hLowBetaMuonBeta_NJets);
  m_sel->AddTObject(hLowBetaMuonBeta_NLeptons);
  m_sel->AddTObject(hLowBetaMuonBeta_LowBetaMuon1Eta);
  m_sel->AddTObject(hLowBetaMuonBeta_LowBetaMuon1pT);
  m_sel->AddTObject(hLowBetaMuonBeta_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hLowBetaMuonBeta_GluinoMass);
  m_sel->AddTObject(hNJets_NLeptons);
  m_sel->AddTObject(hNJets_LowBetaMuon1Eta);
  m_sel->AddTObject(hNJets_LowBetaMuon1pT);
  m_sel->AddTObject(hNJets_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hNJets_GluinoMass);
  m_sel->AddTObject(hNLeptons_LowBetaMuon1Eta);
  m_sel->AddTObject(hNLeptons_LowBetaMuon1pT);
  m_sel->AddTObject(hNLeptons_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hNLeptons_GluinoMass);
  m_sel->AddTObject(hLowBetaMuon1Eta_LowBetaMuon1pT);
  m_sel->AddTObject(hLowBetaMuon1Eta_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hLowBetaMuon1Eta_GluinoMass);
  m_sel->AddTObject(hLowBetaMuon1pT_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hLowBetaMuon1pT_GluinoMass);
  m_sel->AddTObject(hLowBetaMuon1MassBeta_GluinoMass);
  m_sel->AddTObject(hMassCloseZMuons_HtAllJetsAllLeptons);
  m_sel->AddTObject(hMassCloseZMuons_HtAllJets);
  m_sel->AddTObject(hMassCloseZMuons_HtAllLeptons);
  m_sel->AddTObject(hMassCloseZMuons_Met);
  m_sel->AddTObject(hMassCloseZMuons_LowBetaMuonBeta);
  m_sel->AddTObject(hMassCloseZMuons_NJets);
  m_sel->AddTObject(hMassCloseZMuons_NLeptons);
  m_sel->AddTObject(hMassCloseZMuons_LowBetaMuon1Eta);
  m_sel->AddTObject(hMassCloseZMuons_LowBetaMuon1pT);
  m_sel->AddTObject(hMassCloseZMuons_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hMassCloseZMuons_GluinoMass);
  m_sel->AddTObject(hRequireNeutralino_HtAllJetsAllLeptons);
  m_sel->AddTObject(hRequireNeutralino_HtAllJets);
  m_sel->AddTObject(hRequireNeutralino_HtAllLeptons);
  m_sel->AddTObject(hRequireNeutralino_Met);
  m_sel->AddTObject(hRequireNeutralino_LowBetaMuonBeta);
  m_sel->AddTObject(hRequireNeutralino_NJets);
  m_sel->AddTObject(hRequireNeutralino_NLeptons);
  m_sel->AddTObject(hRequireNeutralino_LowBetaMuon1Eta);
  m_sel->AddTObject(hRequireNeutralino_LowBetaMuon1pT);
  m_sel->AddTObject(hRequireNeutralino_LowBetaMuon1MassBeta);
  m_sel->AddTObject(hRequireNeutralino_GluinoMass);
  m_sel->AddTObject(hRequireNeutralino_MassCloseZMuons);
  ...
  m_cutname[2]="no cut";
  m_cutname[3]="Trigger";
  m_cutname[4]="NJET MIN";
  m_cutname[5]="Jets pT cut";
  m_cutname[6]="NLeptons";
  m_cutname[7]="N Low Beta Muons";
  m_cutname[8]="AllJetsAllLeptons";
  m_cutname[9]="LowBetaMuon1Eta";
  m_cutname[10]="ZMass Cut";
  m_cutname[11]="Req Neutralino";
...
void Analysis::doAnalysis(Long64_t entry)
{
  ...
  if (debug >4) std::cout << " Done sorting by pt " << std::endl;
  ...
  std::vector<int> mu_truth_type_wOL;
  ...
  std::vector<int> mu_truth_barcode_wOL;
  ...
  if (!REALDATA) {
    ...
    mu_truth_type_wOL = m_sel->GetFinVectorByType< std::vector<int> >("MUO", "_truth_type");
    ...
    mu_truth_barcode_wOL = m_sel->GetFinVectorByType< std::vector<int> >("MUO", "_truth_barcode");
  ...
  std::vector<float> mulowbeta_truthE_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_truth_E");
  std::vector<int> mulowbeta_truthmatched_f = m_sel->GetFinVectorByType< std::vector<int> >("MULOWBETA", "_truth_matched");
  std::vector<float> mulowbeta_beta_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_beta");
  std::vector<float> mulowbeta_tilebeta_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_TileBeta");
  std::vector<float> mulowbeta_regbeta_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_beta");
  std::vector<float> mulowbeta_tilebetamass_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_TileBetaMass");
  std::vector<float> mulowbeta_mass_f = m_sel->GetFinVectorByType< std::vector<float> >("MULOWBETA", "_m");
  ...
  for ( unsigned int i = 0; i < n_mulowbeta_f; i++){
    ...
    if (usebeta){
      ...
      tempSlepton.SetXYZ(mulowbeta_f.at(i).Px(),mulowbeta_f.at(i).Py(),mulowbeta_f.at(i).Pz()); /// It looks like these values are scaled by 
      slepfake.push_back(tempSlepton);
      float gamma = 1.0/sqrt(1-mulowbeta_beta_f.at(i)*mulowbeta_beta_f.at(i));
      staumass.push_back(slepfake.at(i).Mag()/( mulowbeta_beta_f.at(i) * gamma ) ); /// Add the mu energy directly here.
      if (debug >4) cout << "Mass of the current stau: " << staumass.at(i) <<  "   Beta: " << mulowbeta_beta_f.at(i) << "  Pmag:" << slepfake.at(i).Mag() <<endl;
      tempStau.SetPtEtaPhiM(mulowbeta_f.at(i).Pt(),mulowbeta_f.at(i).Eta(),mulowbeta_f.at(i).Phi(),staumass.at(i));
      ...
      //      tempStau.SetPtEtaPhiM(mulowbeta_f.at(i).Pt(),mulowbeta_f.at(i).Eta(),mulowbeta_f.at(i).Phi(),mulowbeta_f.at(i).M()/1000.0);
      tempStau.SetPtEtaPhiM(mulowbeta_f.at(i).Pt(),mulowbeta_f.at(i).Eta(),mulowbeta_f.at(i).Phi(),mulowbeta_f.at(i).M());
      //      tempStau.SetPtEtaPhiM(mulowbeta_f.at(i).Pt(),mulowbeta_f.at(i).Eta(),mulowbeta_f.at(i).Phi(),mulowbeta_tilebetamass_f.at(i));
      stau_f.push_back(tempStau);
      //      stau_f.push_back(mulowbeta_f.at(i));
    } //else usebeta


    lep_f.push_back(stau_f.at(i));
  ...
  unsigned int n_mu_f=0;
  unsigned int n_mu_f_wOL=m_sel->GetFinSizeByType("MUO");
  
  std::vector<TLorentzVector> mu_f_wOL;
  std::vector<TLorentzVector> mu_f;
  std::vector<float> mu_beta_f_wOL = m_sel->GetFinVectorByType< std::vector<float> >("MUO", "_TileBeta");  
  std::vector<float> mu_charge_wOL = m_sel->GetFinVectorByType< std::vector<float> >("MUO", "_charge");
  std::vector<float> mu_beta_f ;
  std::vector<float> mu_charge ;
  for ( unsigned int i = 0; i < n_mu_f_wOL; i++){
    mu_f_wOL.push_back(m_sel->GetFinFourVecByType("MUO",i));
  }

  for ( unsigned int i = 0; i < n_mu_f_wOL; i++){
    if (debug >4 ) cout << " Nmuons wol " <<n_mu_f_wOL << "  N lowbeta mu  " << n_mulowbeta_f << endl;
    int ismuonoverlapped=0;
      
    for ( unsigned int j = 0; j < n_mulowbeta_f; j++){
      Float_t muonsdR=DeltaR(mu_f_wOL.at(i).Eta(),mu_f_wOL.at(i).Phi(),stau_f.at(j).Eta(),stau_f.at(j).Phi());
      if (debug >4) cout << " dR of muon [" << i << "] lowbetamuon[ " << j << "]   "<< muonsdR << endl;
      if (debug >4 && !REALDATA) cout << "  --  muontruthtype: " << mu_truth_type_wOL.at(i) <<"  lowbetamuontruth: " << mulowbeta_truth_type.at(j) <<  "  --  muonbarcode: " << mu_truth_barcode_wOL.at(i) << "  lowbetamuonbarcode: " << mulowbeta_truth_barcode.at(j) <<endl;
      
      if (muonsdR < 0.01 ){
	ismuonoverlapped=1;
	if (debug >4 ) cout << " Muon is overlaped and rejected ith dR " << muonsdR  << " Nmuons wol " <<n_mu_f_wOL << "  N lowbeta mu  " << n_mulowbeta_f  <<  " N muons " << n_mu_f <<endl;
      }
      
    }//for ( unsigned int j = 0; j < n_mulowbeta_f; j++)
    if (!ismuonoverlapped ){
      if (debug >4 ) cout << " Muon dR passed " << endl;
      n_mu_f++;
      mu_f.push_back(mu_f_wOL.at(i));
      mu_beta_f.push_back(mu_beta_f_wOL.at(i));
      mu_charge.push_back(mu_charge_wOL.at(i));
      
      lep_f.push_back(mu_f_wOL.at(i));
      lep_charge.push_back(mu_charge_wOL.at(i));
      lep_mytype.push_back("mu");
      
      if (!REALDATA){
	mu_truth_type.push_back(mu_truth_type_wOL.at(i));
	mu_truth_barcode.push_back(mu_truth_barcode_wOL.at(i));
	lep_truth_type.push_back(mu_truth_type_wOL.at(i));
	lep_truth_barcode.push_back(mu_truth_barcode_wOL.at(i));
      }
    }// if (!ismuonoverlappedmuonsdR )
    else 
      if (debug >4) cout << "Muon rejected " << endl;
    
  }//for ( unsigned int i = 0; i < n_mu_f_wOL; i++)
  
  if (debug >4 ) cout << " Done selecting muons  " << " Nmuons wol " <<n_mu_f_wOL << "  N lowbeta mu  " << n_mulowbeta_f  <<  " N muons " << n_mu_f << endl;
  
  unsigned int n_mugirl_f=m_sel->GetFinSizeByType("MUGIRL");
  std::vector<TLorentzVector> mugirl_f;
  std::vector<float> mugirl_beta_f = m_sel->GetFinVectorByType< std::vector<float> >("MUGIRL", "_TileBeta");  
  ...
  if (debug >4) cout << " Defining trigger " << endl;

  //  Bool_t EF_mu22_medium = m_sel->GetScalarVal<bool>("EF_mu22_medium");
  Bool_t EF_mu18_medium = m_sel->GetScalarVal<bool>("EF_mu18_medium");
//  Bool_t EF_2mu10_loose = m_sel->GetScalarVal<bool>("EF_2mu10_loose");
//  Bool_t EF_mu40_slow = m_sel->GetScalarVal<bool>("EF_mu40_slow");
//  Bool_t EF_mu40_slow_medium = m_sel->GetScalarVal<bool>("EF_mu40_slow_medium");
//  Bool_t EF_mu40_slow_outOfTime_medium = m_sel->GetScalarVal<bool>("EF_mu40_slow_outOfTime_medium");
//  Bool_t EF_mu40_slow_empty = m_sel->GetScalarVal<bool>("EF_mu40_slow_empty");
//  Bool_t EF_mu40_slow_outOfTime = m_sel->GetScalarVal<bool>("EF_mu40_slow_outOfTime");
//  Bool_t L1_MU11 = m_sel->GetScalarVal<bool>("L1_MU11");
//  Bool_t L1_2MU0;
  //  if (!REALDATA) {
  //    L1_2MU0 = m_sel->GetScalarVal<bool>("L1_2MU0");
  //  }
//  Bool_t L1_MU10 = m_sel->GetScalarVal<bool>("L1_MU10");
//  Bool_t L1_MU10_EMPTY = m_sel->GetScalarVal<bool>("L1_MU10_EMPTY");
//  Bool_t L2_mu22_medium = m_sel->GetScalarVal<bool>("L2_mu22_medium");
  Bool_t L2_mu18_medium = m_sel->GetScalarVal<bool>("L2_mu18_medium");
//  Bool_t L2_2mu10_loose = m_sel->GetScalarVal<bool>("L2_2mu10_loose");
//  Bool_t L2_mu40_slow = m_sel->GetScalarVal<bool>("L2_mu40_slow");
//  Bool_t L2_mu40_slow_medium = m_sel->GetScalarVal<bool>("L2_mu40_slow_medium");
//  Bool_t L2_mu40_slow_outOfTime_medium = m_sel->GetScalarVal<bool>("L2_mu40_slow_outOfTime_medium");
//  Bool_t L2_mu40_slow_empty = m_sel->GetScalarVal<bool>("L2_mu40_slow_empty");
//  Bool_t L2_mu40_slow_outOfTime= m_sel->GetScalarVal<bool>("L2_mu40_slow_outOfTime");

  if (debug >4) cout << " done Defining trigger " << endl;
  ...
  */
  ...
  if (debug >4) cout << " Derfining dilep " << endl;
	
  //     cout << "here 2:" << endl;
  // find the closest dr to the slowbetamuon
  std::vector<float> dRDilep;
  std::vector<TLorentzVector> Dilep;
  float dRmin=100.0;
  int DilepSize=0;
  int dRminIndex=0;
  float dRminSecond=100.0;
  int dRminSecondIndex=0;	
  float dRminJET=100.0;
  int dRminIndexJET=0;
  float dRmin2JET=100.0;
  int dRminIndex2JET=0;
  TLorentzVector neutralino_f,neutralino2_f,squark_f,gluino_f;
  bool founddRMin=false;
  bool founddRSecondMin=false;
  if (debug >4) cout << " Starting dilep " << endl;

  if(n_mulowbeta_f > 0 && n_lep_f > 2 && n_jet_f > 1){
    //     if (debug >0) cout << "n_mulowbeta_f:    " << n_mulowbeta_f<< endl;
    //cout << endl;
    for ( unsigned int i = 0; i < n_lep_f; i++){
      float currentdR=DeltaR(lep_f.at(i).Eta(),lep_f.at(i).Phi(),stau_f.at(0).Eta(),stau_f.at(0).Phi());
      if (currentdR > 0.1 && currentdR < 10.0){
	if (debug > 4) cout << "   i  " << i << endl;
	DilepSize++;
	dRDilep.push_back(currentdR);
	Dilep.push_back(lep_f.at(i)+stau_f.at(0));
	if (debug > 4){
	  cout << " Dilepmass  " << Dilep.at(DilepSize-1).M() << "  lep_f  " << lep_f.at(i).M() << "  stau_f.at(0)  " << stau_f.at(0).M() << "   lowbetamuon  " << mulowbeta_f.at(0).M()  <<  endl;
	  cout << " PT Dilepmass  " << Dilep.at(DilepSize-1).Pt() << "  lep_f  " << lep_f.at(i).Pt() << "  stau_f.at(0)  " << stau_f.at(0).Pt() << "   lowbetamuon  " << mulowbeta_f.at(0).Pt()  << endl;
	  cout << " PX Dilepmass  " << Dilep.at(DilepSize-1).Px() << "  lep_f  " << lep_f.at(i).Px() << "  stau_f.at(0)  " << stau_f.at(0).Px() << "   lowbetamuon  " << mulowbeta_f.at(0).Px() << endl;
	  cout << " PY Dilepmass  " << Dilep.at(DilepSize-1).Py() << "  lep_f  " << lep_f.at(i).Py() << "  stau_f.at(0)  " << stau_f.at(0).Py() << "   lowbetamuon  " << mulowbeta_f.at(0).Py() << endl;
	  cout << " PZ Dilepmass  " << Dilep.at(DilepSize-1).Pz() << "  lep_f  " << lep_f.at(i).Pz() << "  stau_f.at(0)  " << stau_f.at(0).Pz() << "   lowbetamuon  " << mulowbeta_f.at(0).Pz() << endl;
	  cout << " E Dilepmass  " << Dilep.at(DilepSize-1).E() << "  lep_f  " << lep_f.at(i).E() << "  stau_f.at(0)  " << stau_f.at(0).E() << "   lowbetamuon  " << mulowbeta_f.at(0).E() << endl;
	}
	if (currentdR < dRmin ){
	  dRmin=currentdR;
	  dRminIndex=DilepSize-1;
	  founddRMin=true;
	  if (debug >4) cout << "Found one dR " << dRmin << "  index  "<< dRminIndex  <<endl;
	}//if (dRDilep.at(i) < dRmin && dRDilep.at(i)>0.0 )
      }//if (currentdR > 0.1){
    }//for ( unsigned int i = 0; i < n_lep_f; i++)
    if (debug >4) cout << "Finished found one dr foundit? " <<  founddRMin  << "  index " << dRminIndex << endl ;

    if (founddRMin) {
      if (debug >4) cout << "Defining neutralino_f" << endl;
      neutralino_f=Dilep.at(dRminIndex);
      for ( unsigned int i = 0; i < DilepSize ; i++){
	//for ( unsigned int i = 0; i < 0; i++){
	if (dRDilep.at(i) < dRminSecond  && dRDilep.at(i) > dRmin ){
	  if (debug >4) cout << "Found dR 2 min"<< dRDilep.at(i) << endl;
	  dRminSecond=dRDilep.at(i);
	  dRminSecondIndex=i;
	  founddRSecondMin=true;				
	}//if (dRDilep.at(i) < dRmin && dRDilep.at(i)>0.0 )
      }//for ( unsigned int i = 0; i < n_lep_f; i++)
      if (founddRSecondMin) {
	if (debug >4) cout << "Defining neutralino2_f" << endl;
	neutralino2_f=neutralino_f+Dilep.at(dRminSecondIndex)-stau_f.at(0);
	squark_f=neutralino2_f+jet_f.at(0);
	if (debug >4) cout << " Calculated squark_f " << endl;
	if (debug >4) cout << " Loop for drmin2jet " << endl;
      }// if (founddRSecondMin)
    }
    
    for (unsigned int kk=0; kk<n_jet_f; kk++) {
      float jetdR=DeltaR(jet_f.at(dRminIndexJET).Eta(),jet_f.at(dRminIndexJET).Phi(),jet_f.at(kk).Eta(),jet_f.at(kk).Phi());
      if (jetdR<dRmin2JET&&jetdR>0.01) {
	dRmin2JET=jetdR;
	dRminIndex2JET=kk;
      }
    }
    if(founddRSecondMin) gluino_f=squark_f+jet_f.at(dRminIndex2JET);
    if (debug >4) cout << " min dR " << dRmin << "   dR index " << dRminIndex <<  endl;
    
  }//if(n_mulowbeta_f > 0 && n_lep_f > 2 && n_jet_f > 0)
	
  if (debug >4) cout << " Second dRmin " << dRmin << "nlep  " << n_lep_f <<endl;
  if (debug >4){
    cout << "Nlep " << n_lep_f << "  Nmuon: " << n_mu_f << "    Nele: "<< n_el_f << "    Mulowbeta" << n_mulowbeta_f <<  "   nmu wOL " << n_mu_f_wOL << endl;
    cout << " mu_f_wOL " << endl;
    for ( unsigned int ii = 0; ii < n_mu_f_wOL; ii++){
      cout << "Muon wOL pT: " <<  mu_f_wOL.at(ii).Pt()  << endl;
	if (!REALDATA)
	  cout << "   Barcode: "<< mu_truth_barcode_wOL.at(ii)  << endl;
    }
    cout << " el_f " << endl;
    for ( unsigned int ii = 0; ii < n_el_f; ii++){
      cout << "Electron pT: " <<  el_f.at(ii).Pt()  << endl;
	if (!REALDATA)
	  cout << "   Barcode: "<< el_truth_barcode.at(ii)  << endl;
    }
    cout << " mulowbeta_f " << endl;
    for ( unsigned int ii = 0; ii < n_mulowbeta_f; ii++){
      cout << "Mulowbeta pT: " <<  stau_f.at(ii).Pt()  << endl;
	if (!REALDATA)
	  cout << "   Barcode: "<< mulowbeta_truth_barcode.at(ii)  << endl;
    }
    cout << " mu_f " << endl;
    for ( unsigned int ii = 0; ii < n_mu_f; ii++){
      cout << "Muon pT: " <<  mu_f.at(ii).Pt()  << endl;
	if (!REALDATA)
	  cout << "   Barcode: "<< mu_truth_barcode.at(ii)  << endl;
    }
    cout << " nlep_f " << endl;	
    for ( unsigned int ii = 0; ii < n_lep_f; ii++){
      cout << "Lepton pT: " <<  lep_f.at(ii).Pt()  << "  itype "<< lep_mytype.at(ii) <<  endl;
      if (!REALDATA)
	cout << "   Barcode: "<< lep_truth_barcode.at(ii) << "  itype "<< lep_mytype.at(ii) <<  "   lep_truth_type" <<  lep_truth_type.at(ii) << endl;
    }
    cout << "Nlep " << n_lep_f << "  Nmuon: " << n_mu_f << "    Nele: "<< n_el_f << "    Mulowbeta" << n_mulowbeta_f <<endl;
    for ( unsigned int ii = 0; ii < n_mulowbeta_f; ii++){
      for ( unsigned int jj = 0; jj < n_mu_f; jj++){
	cout << "Muon pT: " << "i "<< ii << "  j " << jj << "   " <<  DeltaR(mu_f.at(jj).Eta(),mu_f.at(jj).Phi(),stau_f.at(ii).Eta(),stau_f.at(ii).Phi())  << endl;
      }// for ( unsigned int jj = 0; jj < n_mu_f; jj++)
    }// for ( unsigned int ii = 0; ii < n_mulowbeta_f; ii++)
  }if (debug >4)
  ...
  bool founddRMinLeptons=false;
  bool foundCloseZLeptons=false;
  float MassofZClose=10000000.0;
  for ( unsigned int i =0 ; i < n_lep_f ; i++){
    dRLeptons.push_back(std::vector<float>());
    Mass2Leptons.push_back(std::vector<float>());
    if (debug >4) cout << " Reserved "<<endl;
    for ( unsigned int j =i+1 ; j < n_lep_f ; j++){
      ...
      TLorentzVector Combined2Leptons=lep_f.at(i)+lep_f.at(j);
      Mass2Leptons[i].push_back(Combined2Leptons.M());
      if (debug >4) cout << "Pushed mass and dr i= " << i << "  j= " << j  << "  itype "<< lep_mytype.at(i)  << "   jtype "<< lep_mytype.at(j) << " pti " << lep_f.at(i).Pt()  << " ptj " << lep_f.at(j).Pt()  << endl;
      if (!REALDATA && debug >4) cout << "   ibarcode "<< lep_truth_barcode.at(i) <<"   jbarcode "<< lep_truth_barcode.at(j)  <<endl;
      if (fabs(Mass2Leptons[i][j-i-1] - 80385.0) <  fabs(MassofZClose - 80385.0)){
	foundCloseZLeptons=true;
	MassofZClose=Mass2Leptons[i][j-i-1];
      }
      if ( lep_charge.at(i)*lep_charge.at(j) < 0.0) {
	if ( dRLeptons[i][j-i-1] < dRmin && dRLeptons[i][j-i-1] < 10.0 && dRLeptons[i][j-i-1] > 0.1 ){
	  dRmin=dRLeptons[i][j-i-1];
	  dRminIIndex=i;
	  dRminJIndex=j-1-i;
          founddRMinLeptons=true;
	}
      }//if ( lep_charge.at(i)*lep_charge.at(j) < 0.0)
    }//for ( unsigned int j =i+1 ; j < n_lep_f ; j++)
  ...
  bool foundCloseZMuons=false;
  float MassofZCloseMuons=10000000.0;
  if (debug > 4) cout << "  Number of muons  " << n_mu_f_wOL << endl;
  for ( unsigned int i =0 ; i < n_mu_f_wOL ; i++){
    for ( unsigned int j =i+1 ; j < n_mu_f_wOL ; j++){
      TLorentzVector Combined2Muons=mu_f_wOL.at(i)+mu_f_wOL.at(j);
      if (debug > 4) cout << "  combiend2muons " << Combined2Muons.M() << endl;
      if(fabs(Combined2Muons.M() - 80385.0) <  fabs(MassofZCloseMuons - 80385.0 )){
	foundCloseZMuons=true;
	MassofZCloseMuons=Combined2Muons.M();
      }
    }//for ( unsigned int j =i+1 ; j < n_mu_f_wOL ; j++)
...
if (debug >4) cout << " done for n_lep_f "  << endl;

  float HtJet1Jet2=0.0;
  float HtAllJets=0.0;
  float HtAllObjects=0.0;
  float HJet1Jet2=0.0;
  float HAllJets=0.0;
  float HAllObjects=0.0;
  float HtLepton1Lepton2=0.0;
  float HtAllLeptons=0.0;
  float HtAllJetsAllLeptons=0.0;
  if (n_jet_f >= 2){
    HtJet1Jet2 = jet_f.at(0).Pt() + jet_f.at(1).Pt();
    HJet1Jet2 = jet_f.at(0).E() + jet_f.at(1).E();
    
  }
  if (n_lep_f >= 2){
    HtLepton1Lepton2 = lep_f.at(0).Pt() + lep_f.at(1).Pt();
  }
  
  for (unsigned int i = 0; i < n_jet_f; i++){
    HtAllJets+=jet_f.at(i).Pt();
    HAllJets+=jet_f.at(i).E();
    HtAllObjects+=jet_f.at(i).Pt();
    HAllObjects+=jet_f.at(i).E();
  }

  for (unsigned int i = 0; i < n_lep_f; i++){
    HtAllJets+=lep_f.at(i).Pt();
    HAllJets+=lep_f.at(i).E();
    HtAllObjects+=lep_f.at(i).Pt();
    HAllObjects+=lep_f.at(i).E();
    HtAllLeptons+=lep_f.at(i).Pt();
  }
  HtAllJetsAllLeptons=HtAllJets+HtAllLeptons;
  HtAllObjects+=met;

  h_trigger_muOR_BC->Fill(0);
  //  if(EF_mu22_medium ) h_trigger_muOR_BC->Fill(1);
//  if(EF_2mu10_loose ) h_trigger_muOR_BC->Fill(2);
  if(EF_mu18_medium ) h_trigger_muOR_BC->Fill(3);
//  if(EF_mu40_slow ) h_trigger_muOR_BC->Fill(4);
//  if(EF_mu18_medium || EF_2mu10_loose || EF_mu40_slow ) h_trigger_muOR_BC->Fill(6);
//  if(EF_mu18_medium || EF_2mu10_loose ) h_trigger_muOR_BC->Fill(7);
  if(EF_mu18_medium ) h_trigger_muOR_BC->Fill(8);
//  if(EF_2mu10_loose ) h_trigger_muOR_BC->Fill(9);

  //  if(EF_mu22_medium || EF_mu18_medium || EF_2mu10_loose || EF_mu40_slow ) h_trigger_muOR_BC->Fill(6);
  //  if(EF_mu22_medium || EF_mu18_medium || EF_2mu10_loose ) h_trigger_muOR_BC->Fill(7);
  //  if(EF_mu22_medium || EF_mu18_medium ) h_trigger_muOR_BC->Fill(8);
  //  if(EF_mu22_medium || EF_2mu10_loose ) h_trigger_muOR_BC->Fill(9);

//  if(EF_mu18_medium || EF_2mu10_loose ) h_trigger_muOR_BC->Fill(10);
//  if(EF_mu40_slow || EF_mu40_slow_medium || EF_mu40_slow_outOfTime_medium || EF_mu40_slow_empty || EF_mu40_slow_outOfTime) h_trigger_muOR_BC->Fill(11);
  ...
  if (debug >4) cout << " Donw with ht def  - individual cut"  << endl;
  ...
  //end Weight
  bool IndividualCutPass=true;
	
  ///cut efficiency for individual cut

  //Require triggers
  if (ReqTrigger) {
    //    if (!L1_MU10) IndividualCutPass=false;
    //    if (!L2_mu40_slow) IndividualCutPass=false;
    //    if (!EF_2mu10_loose) IndividualCutPass=false;
    if (!EF_mu18_medium) IndividualCutPass=false;

  }
  
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(3);
  }

  if (debug >4) cout << " individual cut 1"  << endl;
  IndividualCutPass=true;
	


  //N Jet cuts
  if (n_jet_f < NJETMIN) IndividualCutPass=false;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(4);
  }
  IndividualCutPass=true;
	
  if ( n_jet_f > 0) 
    if (jet_f.at(0).Pt() < JETPT1_CUT ) IndividualCutPass=false ;
  if ( n_jet_f > 1) 
    if (jet_f.at(1).Pt() < JETPT2_CUT ) IndividualCutPass=false ;
  if ( n_jet_f > 2) 
    if ( jet_f.at(2).Pt() < JETPT3_CUT ) IndividualCutPass=false ;
  if ( n_jet_f > 3) 
    if ( jet_f.at(3).Pt() < JETPT4_CUT ) IndividualCutPass=false ;

  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(5);
  }
  IndividualCutPass=true;
  ...
  if ( n_lep_f < NLEPMIN ) IndividualCutPass=false;
  
  //  if ( n_el_f <  NELEMIN ) return ;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(6);
  }
  IndividualCutPass=true;
	
  if ( n_mulowbeta_f < NSLOWMUOMIN ) IndividualCutPass=false ;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(7);
  }
  IndividualCutPass=true;
  if (debug >4) cout << " individual cut 6"  << endl;
  ...
  if (ControlTTbar){
    if ( HtAllJetsAllLeptons > 1000000.0 || HtAllJetsAllLeptons < 600000.0  ) IndividualCutPass=false ;
  }
  else{
    if ( HtAllJetsAllLeptons < HTALLJETSALLLEPTONS_CUT ) IndividualCutPass=false ;
  }
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(8);
  }


  if (debug >4) cout << " individual cut 8  cut "<< LOWBETAMUON1ETA_CUT  <<endl;
  IndividualCutPass=true;
	
  if ( n_mulowbeta_f > 0 && fabs(stau_f.at(0).Eta()) > LOWBETAMUON1ETA_CUT ) IndividualCutPass=false ;
	
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(9);
  }

  IndividualCutPass=true;
		
  if (ControlZmumu){
    if (foundCloseZMuons && (MassofZCloseMuons < ZMASSMIN_CUT || MassofZCloseMuons > ZMASSMAX_CUT)) IndividualCutPass=false;    
    if ( HtAllJetsAllLeptons > 900000.0 ) IndividualCutPass=false ;
  }
  else{
    if ( RemoveZWindow && foundCloseZMuons && ( MassofZCloseMuons > ZMASSMIN_CUT) && ( MassofZCloseMuons < ZMASSMAX_CUT ) ) IndividualCutPass=false ;
  }
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(10);
  }

  IndividualCutPass=true;
  if(REQUIRE_NEUTRALINO&&!founddRMin) IndividualCutPass=false ;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(11);
  }

  IndividualCutPass=true;
  if ( HtAllJets < HTALLJETS_CUT ) IndividualCutPass=false ;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(12);
  }

  IndividualCutPass=true;
  if ( HtAllLeptons < HTALLLEPTONS_CUT ) IndividualCutPass=false ;
  if (IndividualCutPass) {
    hCutFlowIndividual->Fill(13);
  }

  /// cut flow for sequential cuts hCutFlow

  if (debug >4) cout << "Finished individual cut study"  << endl;
	
	
  m_cutflow[1]+= (float)mc_event_weight; 
  hCutFlow->Fill(1);
	
  if (debug >4) std::cout << "Got event weight " <<  std::endl;
	
  
  m_cutflow[2]+= (float)mc_event_weight;
  hCutFlow->Fill(2);
  ...
  if (ReqTrigger) {
    ...
    //    if (!EF_2mu10_loose) return;
    if (!EF_mu18_medium) return;
  }
  
  m_cutflow[3]+= (float)mc_event_weight; //dRPhiMEt cut
  hCutFlow->Fill(3);

  //N Jet cuts
  if (n_jet_f < NJETMIN) return ;
  
  m_cutflow[4]+= (float)mc_event_weight; // four jets required
  hCutFlow->Fill(4);
  ...
  if ( n_jet_f > 0) 
    if (jet_f.at(0).Pt() < JETPT1_CUT ) return ;
  if (debug >4)  std::cout << "checked jet 1" << std::endl;
  if ( n_jet_f > 1) 
    if (jet_f.at(1).Pt() < JETPT2_CUT ) return ;
  if (debug >4)  std::cout << "checked jet 2" << std::endl;
  if ( n_jet_f > 2) 
    if ( jet_f.at(2).Pt() < JETPT3_CUT ) return ;
  if (debug >4) std::cout << "checked jet 3" << std::endl;
  if ( n_jet_f > 3) 
    if ( jet_f.at(3).Pt() < JETPT4_CUT ) return ;
  if (debug >4) std::cout << "checked jet 4 " <<  std::endl;
  
  m_cutflow[5]+= (float)mc_event_weight; //jet pt cuts
  hCutFlow->Fill(5);
  if (debug >4) std::cout << "NLeptons:  "<<n_lep_f << "     nel: " << n_el_f <<"     nmu: " << n_mu_f <<"     nlowbeta: " << n_mulowbeta_f <<"     nmug: " << n_mugirl_f << "  NJETS: "<< n_jet_f <<std::endl;
  ...
  m_cutflow[7]+= (float)mc_event_weight; //MET cut
  hCutFlow->Fill(7);
  ...
  if (ControlTTbar){
    if ( HtAllJetsAllLeptons > 1000000.0 || HtAllJetsAllLeptons < 600000.0  ) return ;
    if ( met < 50000.0 ) return ;
  }  
  else{
    if ( HtAllJetsAllLeptons < HTALLJETSALLLEPTONS_CUT ) return ;
    
  }
  m_cutflow[8]+= (float)mc_event_weight; // HtAllJetsCut
  hCutFlow->Fill(8);
	
  

  if (  n_mulowbeta_f > 0 && fabs(stau_f.at(0).Eta()) > LOWBETAMUON1ETA_CUT ) return ;

  m_cutflow[9]+= (float)mc_event_weight; //ST cut
  hCutFlow->Fill(9);

  if (ControlZmumu){
    if (debug > 4 ) cout << "Creating zmumu control region" << endl;
    if (foundCloseZMuons && (MassofZCloseMuons < ZMASSMIN_CUT || MassofZCloseMuons > ZMASSMAX_CUT)) return;
    if ( HtAllJetsAllLeptons > 900000.0 ) return ;
  }
  else{
    if (debug > 4 ) cout << "Removing zclose " << RemoveZWindow <<  "  foubd " << foundCloseZMuons <<endl;
    if ( RemoveZWindow && foundCloseZMuons && ( MassofZCloseMuons > ZMASSMIN_CUT) && ( MassofZCloseMuons < ZMASSMAX_CUT ) ) return ;
  }
  m_cutflow[10]+= (float)mc_event_weight; //ST cut
  hCutFlow->Fill(10);

  if(REQUIRE_NEUTRALINO&&!founddRMin) return;
  m_cutflow[11]+= (float)mc_event_weight;
  hCutFlow->Fill(11);

  if ( HtAllJets < HTALLJETS_CUT ) return ;
  m_cutflow[12]+= (float)mc_event_weight;
  hCutFlow->Fill(12);

  if ( HtAllLeptons < HTALLLEPTONS_CUT ) return ;
  m_cutflow[13]+= (float)mc_event_weight;
  hCutFlow->Fill(13);
  ...
  if (0){
    ...
    if (higgsPerEvent == 1 ){ // first Higgs only case
      ...
      ptb    = jet_f.at(bJetIndex).Pt()/1000.;
      ptbbar = jet_f.at(bbarJetIndex).Pt()/1000.;
	...
	TLorentzVector JetCombined34=	jet_f.at(bJetIndex)+jet_f.at(bbarJetIndex);
        NewMass34 = JetCombined34.M();
  ...
  if ( n_jet_f > 0) hJet1Mass->Fill(jet_f.at(0).M()/1000.0);
  if ( n_jet_f > 1) hJet2Mass->Fill(jet_f.at(1).M()/1000.0);
  if ( n_jet_f > 2) hJet3Mass->Fill(jet_f.at(2).M()/1000.0);
  if ( n_jet_f > 3) hJet4Mass->Fill(jet_f.at(3).M()/1000.0);
	
  //  if ( n_jet_f > 0) cout << "Jet1 mass: " <<jet_f.at(0).M()/1000.0 << endl;
  //  if ( n_jet_f > 1) cout << "Jet2 mass: " <<jet_f.at(1).M()/1000.0 << endl;
  //  if ( n_jet_f > 2) cout << "Jet3 mass: " <<jet_f.at(2).M()/1000.0 << endl;
  //  if ( n_jet_f > 3) cout << "Jet4 mass: " <<jet_f.at(3).M()/1000.0 << endl;
  ...
  if ( n_jet_f > 1)  hHtJet1Jet2->Fill(HtJet1Jet2/1000.0);
  hHtAllJets->Fill(HtAllJets/1000.0);
  hHtAllObjects->Fill(HtAllObjects/1000.0);
  if ( n_jet_f > 1) hHJet1Jet2->Fill(HJet1Jet2/1000.0);
  hHAllJets->Fill(HAllJets/1000.0);
  hHAllObjects->Fill(HAllObjects/1000.0);

  if ( n_lep_f > 1) hHtLepton1Lepton2->Fill(HtLepton1Lepton2/1000.0);
  hHtAllLeptons->Fill(HtAllLeptons/1000.0);
  hHtAllJetsAllLeptons->Fill(HtAllJetsAllLeptons/1000.0);
  // Filling b bar invariant mass
  //  if (!REALDATA) {
  if (0) {
    TLorentzVector BBInvMassJetCombined= jet_f.at(bbarJetIndex)+jet_f.at(bJetIndex);
    double BBInvMass = BBInvMassJetCombined.M();
    lshRecoBBInvMass->Fill(BBInvMass/1000.0);
    if (debug >4) cout << "BBInvMass mass " << BBInvMass << endl;
  }
  if (n_jet_f>3) {
    TLorentzVector JJInvMassJetCombined = jet_f.at(2)+jet_f.at(3);
    double JJInvMass = JJInvMassJetCombined.M();
    lshRecoJJInvMass->Fill(JJInvMass/1000.0);
    if (debug >4) cout << "RecoJJ mass " << JJInvMass << endl;
    
  }
  if (n_el_f > 1 ) {
    TLorentzVector EleInvMassCombined = el_f.at(0)+el_f.at(1);
    double EleInvMass=EleInvMassCombined.M();
    lshRecoEleInvMass->Fill(EleInvMass/1000.0);
  ...
  if (n_el_f > 0 ) hElectron1pT->Fill(el_f.at(0).Pt()/1000.0);
  if (n_el_f > 1 ) hElectron2pT->Fill(el_f.at(1).Pt()/1000.0);
  if (n_el_f > 2 ) hElectron3pT->Fill(el_f.at(2).Pt()/1000.0);
  ...
  if (n_el_f > 0 ) hElectron1Mass->Fill(el_f.at(0).M()/1000.0);
  if (n_el_f > 1 ) hElectron2Mass->Fill(el_f.at(1).M()/1000.0);
  if (n_el_f > 2 ) hElectron3Mass->Fill(el_f.at(2).M()/1000.0);
  ...
  if (n_mu_f > 0 ) hMuon1pT->Fill(mu_f.at(0).Pt()/1000.0);
  if (n_mu_f > 1 ) hMuon2pT->Fill(mu_f.at(1).Pt()/1000.0);
  if (n_mu_f > 2 ) hMuon3pT->Fill(mu_f.at(2).Pt()/1000.0);
  ...
  if (n_mu_f > 0 ) hMuon1Mass->Fill(mu_f.at(0).M()/1000.0);
  if (n_mu_f > 1 ) hMuon2Mass->Fill(mu_f.at(1).M()/1000.0);
  if (n_mu_f > 2 ) hMuon3Mass->Fill(mu_f.at(2).M()/1000.0);
  if (debug >4) if (n_mu_f > 0 ) cout << "            filling mass muon 0: " << mu_f.at(0).M()/1000.0 << endl;
  if (debug >4) if (n_mu_f > 1 ) cout << "            filling mass muon 1: " << mu_f.at(1).M()/1000.0 << endl;
  ...
  Float_t delta_tile_beta;
  Float_t delta_reg_beta;
  Float_t delta_betas;
  Double_t truth_beta;
      
  if (!REALDATA){
    if (mulowbeta_truthmatched_f.at(0) ) {
      Float_t matched_lowbetamuon_mass=findMCmass(mulowbeta_truth_barcode.at(0));
      Float_t matched_lowbetamuon_pt=findMCpT(mulowbeta_truth_barcode.at(0));
      Float_t match_lowbetamuon_delta_pt=stau_f.at(0).Pt()-matched_lowbetamuon_pt;
      Float_t match_lowbetamuon_delta_mass=stau_f.at(0).M()-matched_lowbetamuon_mass;
      Float_t match_lowbetamuon_delta_mass_tilebetamass=stau_f.at(0).M()-mulowbeta_mass_f.at(0);
      truth_beta=TMath::Sqrt(1- 105000*105000/(mulowbeta_truthE_f.at(0)*mulowbeta_truthE_f.at(0)));
      delta_tile_beta=mulowbeta_tilebeta_f.at(0) - truth_beta;
      delta_reg_beta=mulowbeta_regbeta_f.at(0) - truth_beta;
      delta_betas=mulowbeta_tilebeta_f.at(0) - mulowbeta_regbeta_f.at(0);
      
      
      if (debug > 4){
	cout << match_lowbetamuon_delta_mass << "  massdiff   mc_mass "<< matched_lowbetamuon_mass << "  muonmass "<< stau_f.at(0).M() <<endl;
	cout << match_lowbetamuon_delta_mass_tilebetamass << "  massdifftilebetamass   tile_mass "<< mulowbeta_mass_f.at(0) << "  muonmass "<< stau_f.at(0).M() <<endl;
	cout <<  match_lowbetamuon_delta_pt/1000.0 << "  ptdiff   mc_pt " << matched_lowbetamuon_pt << "   muonpt  "<< stau_f.at(0).Pt() <<endl;
	cout <<  delta_tile_beta  << " deta_tile_beta  tilebeta " << delta_reg_beta  << " deta_reg_beta  regbeta " << mulowbeta_regbeta_f.at(0) << "   delta_betas   "<< delta_betas  << "   ismatched   " <<  mulowbeta_truthmatched_f.at(0) <<endl;
      }
    }
  }
  if (debug >4) cout << "Starting to fill mulowbeta " << endl;
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1pT->Fill(stau_f.at(0).Pt()/1000.0);
  if (n_mulowbeta_f > 1 ) hMuLowBetaMuon2pT->Fill(stau_f.at(1).Pt()/1000.0);
  if (n_mulowbeta_f > 2 ) hMuLowBetaMuon3pT->Fill(stau_f.at(2).Pt()/1000.0);
  
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1EtaAbs->Fill(fabs(stau_f.at(0).Eta()));
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1Eta->Fill(stau_f.at(0).Eta());
  if (n_mulowbeta_f > 1 ) hMuLowBetaMuon2Eta->Fill(stau_f.at(1).Eta());
  if (n_mulowbeta_f > 2 ) hMuLowBetaMuon3Eta->Fill(stau_f.at(2).Eta());
  
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1Phi->Fill(stau_f.at(0).Phi());
  if (n_mulowbeta_f > 1 ) hMuLowBetaMuon2Phi->Fill(stau_f.at(1).Phi());
  if (n_mulowbeta_f > 2 ) hMuLowBetaMuon3Phi->Fill(stau_f.at(2).Phi());
  
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1Mass->Fill(stau_f.at(0).M()/1000.0);
  if (n_mulowbeta_f > 1 ) hMuLowBetaMuon2Mass->Fill(stau_f.at(1).M()/1000.0);
  if (n_mulowbeta_f > 2 ) hMuLowBetaMuon3Mass->Fill(stau_f.at(2).M()/1000.0);

  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1MassOrig->Fill(mulowbeta_f.at(0).M()/1000.0);
  if (n_mulowbeta_f > 1 ) hMuLowBetaMuon2MassOrig->Fill(mulowbeta_f.at(1).M()/1000.0);
  if (n_mulowbeta_f > 2 ) hMuLowBetaMuon3MassOrig->Fill(mulowbeta_f.at(2).M()/1000.0);
  ...
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1TruthBeta->Fill(truth_beta);
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1TileBeta->Fill(mulowbeta_tilebeta_f.at(0));
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1DeltaBeta->Fill(delta_reg_beta);
  if (n_mulowbeta_f > 0 ) hMuLowBetaMuon1DeltaTileBeta->Fill(delta_tile_beta);

  if (debug >4) if (n_mulowbeta_f > 0 ) cout << "            filling LOW BETA mass muon 0: " << stau_f.at(0).M()/1000.0 << endl;
  if (debug >4) if (n_mulowbeta_f > 1 ) cout << "            filling LOW BETA mass muon 1: " << stau_f.at(1).M()/1000.0 << endl;

  if(n_mulowbeta_f > 1 ) hdRMuLowBetaMuon1MuLowBetaMuon2->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),stau_f.at(1).Eta(),stau_f.at(1).Phi()));
  if(n_mulowbeta_f > 2 ) hdRMuLowBetaMuon1MuLowBetaMuon3->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),stau_f.at(2).Eta(),stau_f.at(2).Phi()));
  if(n_mulowbeta_f > 2 ) hdRMuLowBetaMuon2MuLowBetaMuon3->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),stau_f.at(2).Eta(),stau_f.at(2).Phi()));

  if(n_mulowbeta_f > 0  && n_mu_f > 0 ) hdRMuLowBetaMuon1Muon1->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),mu_f.at(0).Eta(),mu_f.at(0).Phi()));
  if(n_mulowbeta_f > 0  && n_mu_f > 1 ) hdRMuLowBetaMuon1Muon2->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),mu_f.at(1).Eta(),mu_f.at(1).Phi()));
  if(n_mulowbeta_f > 0  && n_mu_f > 2 ) hdRMuLowBetaMuon1Muon3->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),mu_f.at(2).Eta(),mu_f.at(2).Phi()));
  if(n_mulowbeta_f > 0  && n_el_f > 0 ) hdRMuLowBetaMuon1Electron1->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),el_f.at(0).Eta(),el_f.at(0).Phi()));
  if(n_mulowbeta_f > 0  && n_el_f > 1 ) hdRMuLowBetaMuon1Electron2->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),el_f.at(1).Eta(),el_f.at(1).Phi()));
  if(n_mulowbeta_f > 0  && n_el_f > 2 ) hdRMuLowBetaMuon1Electron3->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),el_f.at(2).Eta(),el_f.at(2).Phi()));
  if(n_mulowbeta_f > 0  && n_jet_f > 0 ) hdRMuLowBetaMuon1Jet1->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),jet_f.at(0).Eta(),jet_f.at(0).Phi()));
  if(n_mulowbeta_f > 0  && n_jet_f > 1 ) hdRMuLowBetaMuon1Jet2->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),jet_f.at(1).Eta(),jet_f.at(1).Phi()));
  if(n_mulowbeta_f > 0  && n_jet_f > 2 ) hdRMuLowBetaMuon1Jet3->Fill(DeltaR(stau_f.at(0).Eta(),stau_f.at(0).Phi(),jet_f.at(2).Eta(),jet_f.at(2).Phi()));
  if(n_mulowbeta_f > 1  && n_mu_f > 0 ) hdRMuLowBetaMuon2Muon1->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),mu_f.at(0).Eta(),mu_f.at(0).Phi()));
  if(n_mulowbeta_f > 1  && n_mu_f > 1 ) hdRMuLowBetaMuon2Muon2->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),mu_f.at(1).Eta(),mu_f.at(1).Phi()));
  if(n_mulowbeta_f > 1  && n_mu_f > 2 ) hdRMuLowBetaMuon2Muon3->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),mu_f.at(2).Eta(),mu_f.at(2).Phi()));
  if(n_mulowbeta_f > 1  && n_el_f > 0 ) hdRMuLowBetaMuon2Electron1->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),el_f.at(0).Eta(),el_f.at(0).Phi()));
  if(n_mulowbeta_f > 1  && n_el_f > 1 ) hdRMuLowBetaMuon2Electron2->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),el_f.at(1).Eta(),el_f.at(1).Phi()));
  if(n_mulowbeta_f > 1  && n_el_f > 2 ) hdRMuLowBetaMuon2Electron3->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),el_f.at(2).Eta(),el_f.at(2).Phi()));
  if(n_mulowbeta_f > 1  && n_jet_f > 0 ) hdRMuLowBetaMuon2Jet1->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),jet_f.at(0).Eta(),jet_f.at(0).Phi()));
  if(n_mulowbeta_f > 1  && n_jet_f > 1 ) hdRMuLowBetaMuon2Jet2->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),jet_f.at(1).Eta(),jet_f.at(1).Phi()));
  if(n_mulowbeta_f > 1  && n_jet_f > 2 ) hdRMuLowBetaMuon2Jet3->Fill(DeltaR(stau_f.at(1).Eta(),stau_f.at(1).Phi(),jet_f.at(2).Eta(),jet_f.at(2).Phi()));
  if(n_mulowbeta_f > 2  && n_mu_f > 0 ) hdRMuLowBetaMuon3Muon1->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),mu_f.at(0).Eta(),mu_f.at(0).Phi()));
  if(n_mulowbeta_f > 2  && n_mu_f > 1 ) hdRMuLowBetaMuon3Muon2->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),mu_f.at(1).Eta(),mu_f.at(1).Phi()));
  if(n_mulowbeta_f > 2  && n_mu_f > 2 ) hdRMuLowBetaMuon3Muon3->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),mu_f.at(2).Eta(),mu_f.at(2).Phi()));
  if(n_mulowbeta_f > 2  && n_el_f > 0 ) hdRMuLowBetaMuon3Electron1->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),el_f.at(0).Eta(),el_f.at(0).Phi()));
  if(n_mulowbeta_f > 2  && n_el_f > 1 ) hdRMuLowBetaMuon3Electron2->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),el_f.at(1).Eta(),el_f.at(1).Phi()));
  if(n_mulowbeta_f > 2  && n_el_f > 2 ) hdRMuLowBetaMuon3Electron3->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),el_f.at(2).Eta(),el_f.at(2).Phi()));
  if(n_mulowbeta_f > 2  && n_jet_f > 0 ) hdRMuLowBetaMuon3Jet1->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),jet_f.at(0).Eta(),jet_f.at(0).Phi()));
  if(n_mulowbeta_f > 2  && n_jet_f > 1 ) hdRMuLowBetaMuon3Jet2->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),jet_f.at(1).Eta(),jet_f.at(1).Phi()));
  if(n_mulowbeta_f > 2  && n_jet_f > 2 ) hdRMuLowBetaMuon3Jet3->Fill(DeltaR(stau_f.at(2).Eta(),stau_f.at(2).Phi(),jet_f.at(2).Eta(),jet_f.at(2).Phi()));
	
  if (debug >4) cout << "Starting to fill mugirl Pt" << endl;
  if (n_mugirl_f > 0 ) hMuGirlMuon1pT->Fill(mugirl_f.at(0).Pt()/1000.0);
  if (n_mugirl_f > 1 ) hMuGirlMuon2pT->Fill(mugirl_f.at(1).Pt()/1000.0);
  if (n_mugirl_f > 2 ) hMuGirlMuon3pT->Fill(mugirl_f.at(2).Pt()/1000.0);
  ...
  if (n_mugirl_f > 0 ) hMuGirlMuon1Mass->Fill(mugirl_f.at(0).M()/1000.0);
  if (n_mugirl_f > 1 ) hMuGirlMuon2Mass->Fill(mugirl_f.at(1).M()/1000.0);
  if (n_mugirl_f > 2 ) hMuGirlMuon3Mass->Fill(mugirl_f.at(2).M()/1000.0);
  ...
  if (founddRMin) {
    ...
    if (debug > 4 )cout <<"    hdRMinDilepInvMass " << Dilep.at(dRminIndex).M()/1000.0 << endl;
    hdRMinDilepInvMass->Fill(Dilep.at(dRminIndex).M()/1000.0);
    h2dInvMassMindRDilep->Fill(Dilep.at(dRminIndex).M()/1000.0,dRDilep.at(dRminIndex));
    hNeutralinoMass->Fill(neutralino_f.M()/1000.0);
    hNeutralinoTransverseMass->Fill(neutralino_f.Mt());
    if (founddRSecondMin) {
      hNeutralino2Mass->Fill(neutralino2_f.M()/1000.0);
      hSquarkMass->Fill(squark_f.M()/1000.0);
      hGluinoMass->Fill(gluino_f.M()/1000.0);
      
      hNeutralino2TransverseMass->Fill(neutralino2_f.Mt());
      hSquarkTransverseMass->Fill(squark_f.Mt());
      hGluinoTransverseMass->Fill(gluino_f.Mt());
      if (debug > 4) {
	cout << "Masses:  Neutralino: " <<neutralino_f.M()/1000.0 <<" Neutralino  2: " <<neutralino2_f.M()/1000.0 <<  "   Squark: " <<squark_f.M()/1000.0 <<"   Gluino: " << gluino_f.M()/1000.0<<endl;
	cout << "Index:  Neutralino: " <<dRminIndex << "   Squark: " <<dRminIndexJET <<"   Gluino: " << dRminIndex2JET<<endl;
	cout << "dR:  Neutralino: " <<dRmin << "   Squark: " <<dRminJET <<"   Gluino: " << dRmin2JET<<endl;
      }//if (debug > 4)
    }//if (founddRSecondMin)
  }
  if(n_mulowbeta_f > 0 && n_lep_f > 2 && n_jet_f > 1){
	...
	hDilepInvMass->Fill(Dilep.at(i).M()/1000.0);
	h2dInvMassdRDilep->Fill(Dilep.at(i).M()/1000.0,dRDilep.at(i));
      }//if (dRdilep.at(i)>0.1)                                                                                                                                                                      
    }//for n_lep_f                                                                                                                                                                                   
  ...
  if(foundCloseZMuons){
    ...
    if (debug > 4) cout << " FILLING THE HISTO  found closezmuon" << MassofZCloseMuons <<endl;

    hMassCloseZMuons->Fill(MassofZCloseMuons);
    
  }
  if (n_lep_f > 1){
    if (foundCloseZLeptons){
      hMassCloseZLeptons->Fill(MassofZClose);
    }
    if(founddRMinLeptons){
      hdRMinLeptons->Fill(dRLeptons[dRminIIndex][dRminJIndex]);
      hMassMindRLeptons->Fill(Mass2Leptons[dRminIIndex][dRminJIndex]);
      if (debug > 4 )cout <<"    hMassMindRLeptons " << Mass2Leptons[dRminIIndex][dRminJIndex] << endl;
  ...
  if (!REALDATA) {
    ...
    for ( unsigned int i = 0; i < n_mu_f; i++){
      BarCodeHistoMuon->Fill(0);
      if (hasTruthBarcode(mulowbeta_truth_barcode,mu_truth_barcode.at(i))){
	if(debug>4) cout << "MU Found it: " << mu_truth_barcode.at(i) << "  Truth type  " << mu_truth_type.at(i) <<endl;
	if ( mu_truth_type.at(i)== 13 ||  mu_truth_type.at(i)== -13) 
	  BarCodeHistoMuon->Fill(1);
	else if ( mu_truth_type.at(i)== 1000015 ||  mu_truth_type.at(i)== -1000015) 
	  BarCodeHistoMuon->Fill(2);
	else  
	  BarCodeHistoMuon->Fill(3);
      }
      if (hasTruthDuplicates(mu_truth_barcode,mu_truth_barcode.at(i))>1)
	BarCodeHistoMuon->Fill(4);
			
    }  
    for ( unsigned int i = 0; i < n_mulowbeta_f; i++){
      BarCodeHistoMuon->Fill(5);
			
      if (hasTruthBarcode(mu_truth_barcode,mulowbeta_truth_barcode.at(i))){
				
	if(debug>4) cout << "MULB Found barcode it: " << mulowbeta_truth_barcode.at(i) <<" Truth type  " << mulowbeta_truth_barcode.at(i) << endl;
	if ( mulowbeta_truth_type.at(i)== 13 ||  mulowbeta_truth_type.at(i)== -13) 
	  BarCodeHistoMuon->Fill(6);
	else if ( mulowbeta_truth_type.at(i)== 1000015 ||  mulowbeta_truth_type.at(i)== -1000015) 
	  BarCodeHistoMuon->Fill(7);
	else  
	  BarCodeHistoMuon->Fill(8);
      }// if hastruthbarcode
      if (hasTruthDuplicates(mulowbeta_truth_type,mulowbeta_truth_type.at(i))>1)
	BarCodeHistoMuon->Fill(9);
  ...
  //   if (n_tau_f > 0 ) hTau1pT->Fill(tau_f.at(0).Pt()/1000.0);
  //   if (n_tau_f > 1 ) hTau2pT->Fill(tau_f.at(1).Pt()/1000.0);
  //   if (n_tau_f > 2 ) hTau3pT->Fill(tau_f.at(2).Pt()/1000.0);
  ...
  //   if (n_tau_f > 0 ) hTau1Mass->Fill(tau_f.at(0).M()/1000.0);
  //   if (n_tau_f > 1 ) hTau2Mass->Fill(tau_f.at(1).M()/1000.0);
  //   if (n_tau_f > 2 ) hTau3Mass->Fill(tau_f.at(2).M()/1000.0);
  ...
  // ABCD Method Study:
  //HtJet1Jet2
  if (debug >4 ) std::cout << "ABCD HTJET1JET1" << endl;
  if(n_jet_f > 1){
    hHtJet1Jet2_Met->Fill(HtJet1Jet2/1000.0,met/1000.0);
    hHtJet1Jet2_NJets->Fill(HtJet1Jet2/1000.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hHtJet1Jet2_LowBetaMuonBeta->Fill(HtJet1Jet2/1000.0,mulowbeta_beta_f.at(0));
      hHtJet1Jet2_LowBetaMuon1Eta->Fill(HtJet1Jet2/1000.0,fabs(stau_f.at(0).Eta()));
      hHtJet1Jet2_LowBetaMuon1pT->Fill(HtJet1Jet2/1000.0,stau_f.at(0).Pt()/1000.0);
      hHtJet1Jet2_LowBetaMuon1MassBeta->Fill(HtJet1Jet2/1000.0,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
	hHtJet1Jet2_GluinoMass->Fill(HtJet1Jet2/1000.0,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0)
      hHtJet1Jet2_NLeptons->Fill(HtJet1Jet2/1000.0,n_lep_f);
    if(n_lep_f > 1)
      hHtJet1Jet2_HtLepton1Lepton2->Fill(HtJet1Jet2/1000.0,HtLepton1Lepton2/1000.0);
  }
	
  if (debug >4 ) std::cout << "ABCD HtLepton1Lepton2" << endl;
  //HtLepton1Lepton2
  if(n_lep_f > 1){
    hHtLepton1Lepton2_Met->Fill(HtLepton1Lepton2/1000.0,met/1000.0);
    hHtLepton1Lepton2_NJets->Fill(HtLepton1Lepton2/1000.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hHtLepton1Lepton2_LowBetaMuonBeta->Fill(HtLepton1Lepton2/1000.0,mulowbeta_beta_f.at(0));
      hHtLepton1Lepton2_LowBetaMuon1Eta->Fill(HtLepton1Lepton2/1000.0,fabs(stau_f.at(0).Eta()));
      hHtLepton1Lepton2_LowBetaMuon1pT->Fill(HtLepton1Lepton2/1000.0,stau_f.at(0).Pt()/1000.0);
      hHtLepton1Lepton2_LowBetaMuon1MassBeta->Fill(HtLepton1Lepton2/1000.0,stau_f.at(0).M()/1000.0);
      hHtLepton1Lepton2_GluinoMass->Fill(HtLepton1Lepton2/1000.0,gluino_f.M()/1000.0);
    }
    hHtLepton1Lepton2_NLeptons->Fill(HtLepton1Lepton2/1000.0,n_lep_f);
  }
	
  if (debug >4 ) std::cout << "ABCD HtAllJets" << endl;
  //HtAllJets
  if(n_jet_f > 0){
    hHtAllJets_Met->Fill(HtAllJets/1000.0,met/1000.0);
    hHtAllJets_NJets->Fill(HtAllJets/1000.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hHtAllJets_LowBetaMuonBeta->Fill(HtAllJets/1000.0,mulowbeta_beta_f.at(0));
      hHtAllJets_LowBetaMuon1Eta->Fill(HtAllJets/1000.0,fabs(stau_f.at(0).Eta()));
      hHtAllJets_LowBetaMuon1pT->Fill(HtAllJets/1000.0,stau_f.at(0).Pt()/1000.0);
      hHtAllJets_LowBetaMuon1MassBeta->Fill(HtAllJets/1000.0,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
	hHtAllJets_GluinoMass->Fill(HtAllJets/1000.0,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0){
      hHtAllJets_NLeptons->Fill(HtAllJets/1000.0,n_lep_f);
      hHtAllJets_HtAllLeptons->Fill(HtAllJets/1000.0,HtAllLeptons/1000.0);
    }
  }
	
  //HtAllJetsAllLeptons
  if (debug >4 ) std::cout << "ABCD HtAllJetsAllLeptons" << endl;

  if(n_jet_f > 0 && n_lep_f > 0){
    hHtAllJetsAllLeptons_Met->Fill(HtAllJetsAllLeptons/1000.0,met/1000.0);
    hHtAllJetsAllLeptons_NJets->Fill(HtAllJetsAllLeptons/1000.0,n_jet_f);
    if (debug >4 ) std::cout << "ABCD HtAllJetsAllLeptons - 1" << endl;
    if (n_mulowbeta_f>0) {
      hHtAllJetsAllLeptons_LowBetaMuonBeta->Fill(HtAllJetsAllLeptons/1000.0,mulowbeta_beta_f.at(0));
      hHtAllJetsAllLeptons_LowBetaMuon1Eta->Fill(HtAllJetsAllLeptons/1000.0,fabs(stau_f.at(0).Eta()));
      hHtAllJetsAllLeptons_LowBetaMuon1pT->Fill(HtAllJetsAllLeptons/1000.0,stau_f.at(0).Pt()/1000.0);
      hHtAllJetsAllLeptons_LowBetaMuon1MassBeta->Fill(HtAllJetsAllLeptons/1000.0,stau_f.at(0).M()/1000.0);
    if (debug >4 ) std::cout << "ABCD HtAllJetsAllLeptons - 2" << endl;
      if(n_lep_f > 1)
	hHtAllJetsAllLeptons_GluinoMass->Fill(HtAllJetsAllLeptons/1000.0,gluino_f.M()/1000.0);
    }
    if (debug >4 ) std::cout << "ABCD HtAllJetsAllLeptons - 3" << endl;

    hHtAllJetsAllLeptons_NLeptons->Fill(HtAllJetsAllLeptons/1000.0,n_lep_f);
    if (debug >4 ) std::cout << "ABCD HtAllJetsAllLeptons - 4" << endl;
  }
	
  //HtAllLeptons
  if (debug >4 ) std::cout << "ABCD HtAllLeptons" << endl;

  if(n_lep_f > 0){
    hHtAllLeptons_Met->Fill(HtAllLeptons/1000.0,met/1000.0);
    hHtAllLeptons_NJets->Fill(HtAllLeptons/1000.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hHtAllLeptons_LowBetaMuonBeta->Fill(HtAllLeptons/1000.0,mulowbeta_beta_f.at(0));
      hHtAllLeptons_LowBetaMuon1Eta->Fill(HtAllLeptons/1000.0,fabs(stau_f.at(0).Eta()));
      hHtAllLeptons_LowBetaMuon1pT->Fill(HtAllLeptons/1000.0,stau_f.at(0).Pt()/1000.0);
      hHtAllLeptons_LowBetaMuon1MassBeta->Fill(HtAllLeptons/1000.0,stau_f.at(0).M()/1000.0);
      hHtAllLeptons_GluinoMass->Fill(HtAllLeptons/1000.0,gluino_f.M()/1000.0);
    }
    hHtAllLeptons_NLeptons->Fill(HtAllLeptons/1000.0,n_lep_f);
  }
	
  //Jet1 Pt
  if (debug >4 ) std::cout << "ABCD Jet1 Pt " << endl;

  if(n_jet_f > 0){
    hJet1Pt_Met->Fill(jet_f.at(0).Pt()/1000.0,met/1000.0);
    hJet1Pt_NJets->Fill(jet_f.at(0).Pt()/1000.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hJet1Pt_LowBetaMuonBeta->Fill(jet_f.at(0).Pt()/1000.0,mulowbeta_beta_f.at(0));
      hJet1Pt_LowBetaMuon1Eta->Fill(jet_f.at(0).Pt()/1000.0,fabs(stau_f.at(0).Eta()));
      hJet1Pt_LowBetaMuon1pT->Fill(jet_f.at(0).Pt()/1000.0,stau_f.at(0).Pt()/1000.0);
      hJet1Pt_LowBetaMuon1MassBeta->Fill(jet_f.at(0).Pt()/1000.0,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
	hJet1Pt_GluinoMass->Fill(jet_f.at(0).Pt()/1000.0,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0)
      hJet1Pt_NLeptons->Fill(jet_f.at(0).Pt()/1000.0,n_lep_f);
  }
	
  //Met
  if (debug >4 ) std::cout << "ABCD Met" << endl;
  if(n_jet_f > 0)
    hMet_NJets->Fill(met/1000.0,n_jet_f);
  if (n_mulowbeta_f>0) {
    hMet_LowBetaMuonBeta->Fill(met/1000.0,mulowbeta_beta_f.at(0));
    hMet_LowBetaMuon1Eta->Fill(met/1000.0,fabs(stau_f.at(0).Eta()));
    hMet_LowBetaMuon1pT->Fill(met/1000.0,stau_f.at(0).Pt()/1000.0);
    hMet_LowBetaMuon1MassBeta->Fill(met/1000.0,stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hMet_GluinoMass->Fill(met/1000.0,gluino_f.M()/1000.0);
  }
  if(n_lep_f > 0)
    hMet_NLeptons->Fill(met/1000.0,n_lep_f);
	
  //LowBetaMuonBeta
  if (debug >4 ) std::cout << "ABCD LowBetamUonBeta" << endl;
  if (n_mulowbeta_f > 0){
  if(n_jet_f > 0 )
    hLowBetaMuonBeta_NJets->Fill(mulowbeta_beta_f.at(0),n_jet_f);
    hLowBetaMuonBeta_LowBetaMuon1Eta->Fill(mulowbeta_beta_f.at(0),fabs(stau_f.at(0).Eta()));
    hLowBetaMuonBeta_LowBetaMuon1pT->Fill(mulowbeta_beta_f.at(0),stau_f.at(0).Pt()/1000.0);
    hLowBetaMuonBeta_LowBetaMuon1MassBeta->Fill(mulowbeta_beta_f.at(0),stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hLowBetaMuonBeta_GluinoMass->Fill(mulowbeta_beta_f.at(0),gluino_f.M()/1000.0);
  if(n_lep_f > 0)
    hLowBetaMuonBeta_NLeptons->Fill(mulowbeta_beta_f.at(0),n_lep_f);
  }	
  // NJets
  if (debug >4 ) std::cout << "ABCD NJets" << endl;
  if (n_mulowbeta_f>0) {
    hNJets_LowBetaMuon1Eta->Fill(n_jet_f,fabs(stau_f.at(0).Eta()));
    hNJets_LowBetaMuon1pT->Fill(n_jet_f,stau_f.at(0).Pt()/1000.0);
    hNJets_LowBetaMuon1MassBeta->Fill(n_jet_f,stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hNJets_GluinoMass->Fill(n_jet_f,gluino_f.M()/1000.0);
  }
  if(n_lep_f > 0)
    hNJets_NLeptons->Fill(n_jet_f,n_lep_f);
	
  // NLeptons
  if (debug >4 ) std::cout << "ABCD NLeptons" << endl;
  if (n_mulowbeta_f>0) {
    hNLeptons_LowBetaMuon1Eta->Fill(n_lep_f,fabs(stau_f.at(0).Eta()));
    hNLeptons_LowBetaMuon1pT->Fill(n_lep_f,stau_f.at(0).Pt()/1000.0);
    hNLeptons_LowBetaMuon1MassBeta->Fill(n_lep_f,stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hNLeptons_GluinoMass->Fill(n_lep_f,gluino_f.M()/1000.0);
  }
	
  // LowBetaMuon1Eta
  if (debug >4 ) std::cout << "ABCD LowBetaMuon1Eta" << endl;
  if (n_mulowbeta_f>0) {
    hLowBetaMuon1Eta_LowBetaMuon1pT->Fill(fabs(stau_f.at(0).Eta()),stau_f.at(0).Pt()/1000.0);
    hLowBetaMuon1Eta_LowBetaMuon1MassBeta->Fill(fabs(stau_f.at(0).Eta()),stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hLowBetaMuon1Eta_GluinoMass->Fill(fabs(stau_f.at(0).Eta()),gluino_f.M()/1000.0);
  }
	
  // LowBetaMuon1pT
  if (debug >4 ) std::cout << "ABCD LowBetaMuon1Pt" << endl;
  if (n_mulowbeta_f>0) {
    hLowBetaMuon1pT_LowBetaMuon1MassBeta->Fill(stau_f.at(0).Pt()/1000.0,stau_f.at(0).M()/1000.0);
    if(n_lep_f > 1)
      hLowBetaMuon1pT_GluinoMass->Fill(stau_f.at(0).Pt()/1000.0,gluino_f.M()/1000.0);
  }
	
  // LowBetaMuon1MassBeta
  if (debug >4 ) std::cout << "ABCD LowBetaMuion1MassBeta" << endl;
  if (n_mulowbeta_f>0) {
    if(n_lep_f > 1)
      hLowBetaMuon1MassBeta_GluinoMass->Fill(stau_f.at(0).M()/1000.0,gluino_f.M()/1000.0);
  }

  if(foundCloseZMuons){
    hMassCloseZMuons_Met->Fill(MassofZCloseMuons,met/1000.0);
    hMassCloseZMuons_NJets->Fill(MassofZCloseMuons,n_jet_f);
    if (n_mulowbeta_f>0) {
      hMassCloseZMuons_LowBetaMuonBeta->Fill(MassofZCloseMuons,mulowbeta_beta_f.at(0));
      hMassCloseZMuons_LowBetaMuon1Eta->Fill(MassofZCloseMuons,fabs(stau_f.at(0).Eta()));
      hMassCloseZMuons_LowBetaMuon1pT->Fill(MassofZCloseMuons,stau_f.at(0).Pt()/1000.0);
      hMassCloseZMuons_LowBetaMuon1MassBeta->Fill(MassofZCloseMuons,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
        hMassCloseZMuons_GluinoMass->Fill(MassofZCloseMuons,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0){
      hMassCloseZMuons_NLeptons->Fill(MassofZCloseMuons,n_lep_f);
      hMassCloseZMuons_HtAllLeptons->Fill(MassofZCloseMuons,HtAllLeptons/1000.0);
    }
    if(n_jet_f > 0){
      hMassCloseZMuons_HtAllJets->Fill(MassofZCloseMuons,HtAllJets/1000.0);
      if(n_lep_f > 0)
	hMassCloseZMuons_HtAllJetsAllLeptons->Fill(MassofZCloseMuons,HtAllJetsAllLeptons/1000.0);

    }
  }

  if(founddRMin){
    hRequireNeutralino_Met->Fill(1.0,met/1000.0);
    hRequireNeutralino_NJets->Fill(1.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hRequireNeutralino_LowBetaMuonBeta->Fill(1.0,mulowbeta_beta_f.at(0));
      hRequireNeutralino_LowBetaMuon1Eta->Fill(1.0,fabs(stau_f.at(0).Eta()));
      hRequireNeutralino_LowBetaMuon1pT->Fill(1.0,stau_f.at(0).Pt()/1000.0);
      hRequireNeutralino_LowBetaMuon1MassBeta->Fill(1.0,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
	hRequireNeutralino_GluinoMass->Fill(1.0,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0){
      hRequireNeutralino_NLeptons->Fill(1.0,n_lep_f);
      hRequireNeutralino_HtAllLeptons->Fill(1.0,HtAllLeptons/1000.0);
    }
    if(n_jet_f > 0){
      hRequireNeutralino_HtAllJets->Fill(1.0,HtAllJets/1000.0);
      if(n_lep_f > 0)
	hRequireNeutralino_HtAllJetsAllLeptons->Fill(1.0,HtAllJetsAllLeptons/1000.0);
    }
    if(foundCloseZMuons)
      hRequireNeutralino_MassCloseZMuons->Fill(1.0,MassofZCloseMuons);
  }
  else{
    hRequireNeutralino_Met->Fill(0.0,met/1000.0);
    hRequireNeutralino_NJets->Fill(0.0,n_jet_f);
    if (n_mulowbeta_f>0) {
      hRequireNeutralino_LowBetaMuonBeta->Fill(0.0,mulowbeta_beta_f.at(0));
      hRequireNeutralino_LowBetaMuon1Eta->Fill(0.0,fabs(stau_f.at(0).Eta()));
      hRequireNeutralino_LowBetaMuon1pT->Fill(0.0,stau_f.at(0).Pt()/1000.0);
      hRequireNeutralino_LowBetaMuon1MassBeta->Fill(0.0,stau_f.at(0).M()/1000.0);
      if(n_lep_f > 1)
	hRequireNeutralino_GluinoMass->Fill(0.0,gluino_f.M()/1000.0);
    }
    if(n_lep_f > 0){
      hRequireNeutralino_NLeptons->Fill(0.0,n_lep_f);
      hRequireNeutralino_HtAllLeptons->Fill(0.0,HtAllLeptons/1000.0);
    }
    if(n_jet_f > 0){
      hRequireNeutralino_HtAllJets->Fill(0.0,HtAllJets/1000.0);
      if(n_lep_f > 0)
	hRequireNeutralino_HtAllJetsAllLeptons->Fill(0.0,HtAllJetsAllLeptons/1000.0);
    }
    if(foundCloseZMuons)
      hRequireNeutralino_MassCloseZMuons->Fill(0.0,MassofZCloseMuons);
  }
  
	
  //TRIGGERS STUDY
  //  if(EF_mu22_medium) h_EF_mu22_medium->Fill(3);
  //  if(L2_mu22_medium) h_EF_mu22_medium->Fill(2);
  //  if(L1_MU11) h_EF_mu22_medium->Fill(1);
  //  if(EF_mu22_medium && L2_mu22_medium && L1_MU11) h_EF_mu22_medium->Fill(4);
  //  if(L2_mu22_medium && L1_MU11) h_EF_mu22_medium->Fill(4);

  if(EF_mu18_medium) h_EF_mu18_medium->Fill(3);
  if(L2_mu18_medium) h_EF_mu18_medium->Fill(2);
//  if(L1_MU11) h_EF_mu18_medium->Fill(1);
//  if(EF_mu18_medium && L2_mu18_medium && L1_MU11 ) h_EF_mu18_medium->Fill(4);

//  if(EF_2mu10_loose) h_EF_2mu10_loose->Fill(3);
//  if(L2_2mu10_loose) h_EF_2mu10_loose->Fill(2);
  //  if (!REALDATA) {
    //    if(L1_2MU0) h_EF_2mu10_loose->Fill(1);
    //    if(EF_2mu10_loose && L2_2mu10_loose && L1_2MU0) h_EF_2mu10_loose->Fill(4);
  //  }
//  if(EF_mu40_slow) h_EF_mu40_slow->Fill(3);
//  if(L2_mu40_slow) h_EF_mu40_slow->Fill(2);
//  if(L1_MU10) h_EF_mu40_slow->Fill(1);
//  if(EF_mu40_slow && L2_mu40_slow && L1_MU10 ) h_EF_mu40_slow->Fill(4);

//  if(EF_mu40_slow_medium) h_EF_mu40_slow_medium->Fill(3);
//  if(L2_mu40_slow_medium) h_EF_mu40_slow_medium->Fill(2);
//  if(L1_MU11) h_EF_mu40_slow_medium->Fill(1);
//  if(EF_mu40_slow_medium && L2_mu40_slow_medium && L1_MU11 ) h_EF_mu40_slow_medium->Fill(4);
 
//  if(EF_mu40_slow_outOfTime_medium) h_EF_mu40_slow_outOfTime_medium->Fill(3);
//  if(L2_mu40_slow_outOfTime_medium) h_EF_mu40_slow_outOfTime_medium->Fill(2);
//  if(L1_MU11) h_EF_mu40_slow_outOfTime_medium->Fill(1);
//  if(EF_mu40_slow_outOfTime_medium && L2_mu40_slow_outOfTime_medium && L1_MU11) h_EF_mu40_slow_outOfTime_medium->Fill(4);

//  if(EF_mu40_slow_empty) h_EF_mu40_slow_empty->Fill(3);
//  if(L2_mu40_slow_empty) h_EF_mu40_slow_empty->Fill(2);
//  if(L1_MU10_EMPTY) h_EF_mu40_slow_empty->Fill(1);
//  if(EF_mu40_slow_empty && L2_mu40_slow_empty && L1_MU10_EMPTY) h_EF_mu40_slow_empty->Fill(4);

//  if(EF_mu40_slow_outOfTime) h_EF_mu40_slow_outOfTime->Fill(3);
//  if(L2_mu40_slow_outOfTime) h_EF_mu40_slow_outOfTime->Fill(2);
//  if(L1_MU10) h_EF_mu40_slow_outOfTime->Fill(1);
//  if(EF_mu40_slow_outOfTime && L2_mu40_slow_outOfTime && L1_MU10) h_EF_mu40_slow_outOfTime->Fill(4);

  h_trigger_muOR->Fill(0);
  //  if(EF_mu22_medium ) h_trigger_muOR->Fill(1);
//  if(EF_2mu10_loose ) h_trigger_muOR->Fill(2);
  if(EF_mu18_medium ) h_trigger_muOR->Fill(3);
//  if(EF_mu40_slow ) h_trigger_muOR->Fill(4);
//  if( EF_mu18_medium || EF_2mu10_loose || EF_mu40_slow ) h_trigger_muOR->Fill(6);
//  if( EF_mu18_medium || EF_2mu10_loose ) h_trigger_muOR->Fill(7);
  if( EF_mu18_medium ) h_trigger_muOR->Fill(8);
//  if( EF_2mu10_loose ) h_trigger_muOR->Fill(9);
//  if(EF_mu18_medium || EF_2mu10_loose ) h_trigger_muOR->Fill(10);
//  if(EF_mu40_slow || EF_mu40_slow_medium || EF_mu40_slow_outOfTime_medium || EF_mu40_slow_empty || EF_mu40_slow_outOfTime) h_trigger_muOR->Fill(11);
...
//      } // if(L1_MU10)
    ...
    if (n_mulowbeta_f > 0) {
      ...
      hn_slow_sel_pt->Fill(stau_f.at(0).Pt()/1000.0);
      hn_slow_sel_eta->Fill(stau_f.at(0).Eta());
      hn_slow_sel_phi->Fill(stau_f.at(0).Phi());
      
//      if(L1_MU10){ 
//        hn_slow_sel_L1_pt->Fill(stau_f.at(0).Pt()/1000.0);
//        hn_slow_sel_L1_eta->Fill(stau_f.at(0).Eta());
//        hn_slow_sel_L1_phi->Fill(stau_f.at(0).Phi());
//        if(L2_mu40_slow){
//          hn_slow_sel_L2_pt->Fill(stau_f.at(0).Pt()/1000.0);
//          hn_slow_sel_L2_eta->Fill(stau_f.at(0).Eta());
//          hn_slow_sel_L2_phi->Fill(stau_f.at(0).Phi());
////          if(EF_mu40_slow){
////            hn_slow_sel_EF_pt->Fill(stau_f.at(0).Pt()/1000.0);
////            hn_slow_sel_EF_eta->Fill(stau_f.at(0).Eta());
////            hn_slow_sel_EF_phi->Fill(stau_f.at(0).Phi());
////          } //if(EF_mu40_slow)
//        } //if(L2_mu40_slow)
//      } //if(L1_MU10)
    }// if (n_mulowbeta_f > 0)    
...
/*static*/ void Analysis::postAnalysis (TSelectorList* fOutput)
{
  ...
  TH1D *hCutFlowIndividual = (TH1D*)fOutput->FindObject("hCutFlowIndividual")->Clone();
  hCutFlowIndividual->Write();
  ...
  TH1D *hHtJet1Jet2 = (TH1D*)fOutput->FindObject("hHtJet1Jet2")->Clone();
  hHtJet1Jet2->Write();
  TH1D *hHtAllJets = (TH1D*)fOutput->FindObject("hHtAllJets")->Clone();
  hHtAllJets->Write();
  TH1D *hHtAllObjects = (TH1D*)fOutput->FindObject("hHtAllObjects")->Clone();
  hHtAllObjects->Write();
  TH1D *hHJet1Jet2 = (TH1D*)fOutput->FindObject("hHJet1Jet2")->Clone();
  hHJet1Jet2->Write();
  TH1D *hHAllJets = (TH1D*)fOutput->FindObject("hHAllJets")->Clone();
  hHAllJets->Write();
  TH1D *hHAllObjects = (TH1D*)fOutput->FindObject("hHAllObjects")->Clone();
  hHAllObjects->Write();  
  TH1D *hHtLepton1Lepton2 = (TH1D*)fOutput->FindObject("hHtLepton1Lepton2")->Clone();
  hHtLepton1Lepton2->Write();
  TH1D *hHtAllLeptons = (TH1D*)fOutput->FindObject("hHtAllLeptons")->Clone();
  hHtAllLeptons->Write();
  TH1D *hHtAllJetsAllLeptons = (TH1D*)fOutput->FindObject("hHtAllJetsAllLeptons")->Clone();
  hHtAllJetsAllLeptons->Write();
  ...
  TH1D *hMuLowBetaMuon1EtaAbs = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1EtaAbs")->Clone();
  hMuLowBetaMuon1EtaAbs->Write();
  ...
  TH1D *hMuLowBetaMuon1MassOrig = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1MassOrig")->Clone();
  hMuLowBetaMuon1MassOrig->Write();
  
  TH1D *hMuLowBetaMuon2MassOrig = (TH1D*)fOutput->FindObject("hMuLowBetaMuon2MassOrig")->Clone();
  hMuLowBetaMuon2MassOrig->Write();
  
  TH1D *hMuLowBetaMuon3MassOrig = (TH1D*)fOutput->FindObject("hMuLowBetaMuon3MassOrig")->Clone();
  hMuLowBetaMuon3MassOrig->Write();
	
  TH1D *hMuLowBetaMuon1Beta = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1Beta")->Clone();
  hMuLowBetaMuon1Beta->Write();
  
  TH1D *hMuLowBetaMuon1TileBeta = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1TileBeta")->Clone();
  hMuLowBetaMuon1TileBeta->Write();

  TH1D *hMuLowBetaMuon1DeltaBeta = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1DeltaBeta")->Clone();
  hMuLowBetaMuon1DeltaBeta->Write();

  TH1D *hMuLowBetaMuon1DeltaTileBeta = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1DeltaTileBeta")->Clone();
  hMuLowBetaMuon1DeltaTileBeta->Write();

  TH1D *hMuLowBetaMuon1TruthBeta = (TH1D*)fOutput->FindObject("hMuLowBetaMuon1TruthBeta")->Clone();
  hMuLowBetaMuon1TruthBeta->Write();
  ...
  TH1D *hdRMuLowBetaMuon1MuLowBetaMuon2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1MuLowBetaMuon2")->Clone();
  hdRMuLowBetaMuon1MuLowBetaMuon2->Write();
  TH1D *hdRMuLowBetaMuon1MuLowBetaMuon3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1MuLowBetaMuon3")->Clone();
  hdRMuLowBetaMuon1MuLowBetaMuon3->Write();
  TH1D *hdRMuLowBetaMuon2MuLowBetaMuon3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2MuLowBetaMuon3")->Clone();
  hdRMuLowBetaMuon2MuLowBetaMuon3->Write();

  TH1D *hdRMuLowBetaMuon1Muon1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Muon1")->Clone();
  hdRMuLowBetaMuon1Muon1->Write();
  TH1D *hdRMuLowBetaMuon1Muon2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Muon2")->Clone();
  hdRMuLowBetaMuon1Muon2->Write();
  TH1D *hdRMuLowBetaMuon1Muon3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Muon3")->Clone();
  hdRMuLowBetaMuon1Muon3->Write();
  TH1D *hdRMuLowBetaMuon1Electron1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Electron1")->Clone();
  hdRMuLowBetaMuon1Electron1->Write();
  TH1D *hdRMuLowBetaMuon1Electron2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Electron2")->Clone();
  hdRMuLowBetaMuon1Electron2->Write();
  TH1D *hdRMuLowBetaMuon1Electron3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Electron3")->Clone();
  hdRMuLowBetaMuon1Electron3->Write();
  TH1D *hdRMuLowBetaMuon1Jet1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Jet1")->Clone();
  hdRMuLowBetaMuon1Jet1->Write();
  TH1D *hdRMuLowBetaMuon1Jet2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Jet2")->Clone();
  hdRMuLowBetaMuon1Jet2->Write();
  TH1D *hdRMuLowBetaMuon1Jet3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon1Jet3")->Clone();
  hdRMuLowBetaMuon1Jet3->Write();
  TH1D *hdRMuLowBetaMuon2Muon1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Muon1")->Clone();
  hdRMuLowBetaMuon2Muon1->Write();
  TH1D *hdRMuLowBetaMuon2Muon2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Muon2")->Clone();
  hdRMuLowBetaMuon2Muon2->Write();
  TH1D *hdRMuLowBetaMuon2Muon3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Muon3")->Clone();
  hdRMuLowBetaMuon2Muon3->Write();
  TH1D *hdRMuLowBetaMuon2Electron1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Electron1")->Clone();
  hdRMuLowBetaMuon2Electron1->Write();
  TH1D *hdRMuLowBetaMuon2Electron2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Electron2")->Clone();
  hdRMuLowBetaMuon2Electron2->Write();
  TH1D *hdRMuLowBetaMuon2Electron3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Electron3")->Clone();
  hdRMuLowBetaMuon2Electron3->Write();
  TH1D *hdRMuLowBetaMuon2Jet1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Jet1")->Clone();
  hdRMuLowBetaMuon2Jet1->Write();
  TH1D *hdRMuLowBetaMuon2Jet2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Jet2")->Clone();
  hdRMuLowBetaMuon2Jet2->Write();
  TH1D *hdRMuLowBetaMuon2Jet3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon2Jet3")->Clone();
  hdRMuLowBetaMuon2Jet3->Write();
  TH1D *hdRMuLowBetaMuon3Muon1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Muon1")->Clone();
  hdRMuLowBetaMuon3Muon1->Write();
  TH1D *hdRMuLowBetaMuon3Muon2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Muon2")->Clone();
  hdRMuLowBetaMuon3Muon2->Write();
  TH1D *hdRMuLowBetaMuon3Muon3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Muon3")->Clone();
  hdRMuLowBetaMuon3Muon3->Write();
  TH1D *hdRMuLowBetaMuon3Electron1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Electron1")->Clone();
  hdRMuLowBetaMuon3Electron1->Write();
  TH1D *hdRMuLowBetaMuon3Electron2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Electron2")->Clone();
  hdRMuLowBetaMuon3Electron2->Write();
  TH1D *hdRMuLowBetaMuon3Electron3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Electron3")->Clone();
  hdRMuLowBetaMuon3Electron3->Write();
  TH1D *hdRMuLowBetaMuon3Jet1 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Jet1")->Clone();
  hdRMuLowBetaMuon3Jet1->Write();
  TH1D *hdRMuLowBetaMuon3Jet2 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Jet2")->Clone();
  hdRMuLowBetaMuon3Jet2->Write();
  TH1D *hdRMuLowBetaMuon3Jet3 = (TH1D*)fOutput->FindObject("hdRMuLowBetaMuon3Jet3")->Clone();
  hdRMuLowBetaMuon3Jet3->Write();
  ...
  //	TH1D * = (TH1D*)fOutput->FindObject("")->Clone();
  //  ->Write();
  TH1D *hNeutralinoMass = (TH1D*)fOutput->FindObject("hNeutralinoMass")->Clone();
  hNeutralinoMass->Write();
  TH1D *hNeutralino2Mass = (TH1D*)fOutput->FindObject("hNeutralino2Mass")->Clone();
  hNeutralino2Mass->Write();
  TH1D *hSquarkMass = (TH1D*)fOutput->FindObject("hSquarkMass")->Clone();
  hSquarkMass->Write();
  TH1D *hGluinoMass = (TH1D*)fOutput->FindObject("hGluinoMass")->Clone();
  hGluinoMass->Write();
	
  TH1D *hNeutralinoTransverseMass = (TH1D*)fOutput->FindObject("hNeutralinoTransverseMass")->Clone();
  hNeutralinoTransverseMass->Write();
  TH1D *hNeutralino2TransverseMass = (TH1D*)fOutput->FindObject("hNeutralino2TransverseMass")->Clone();
  hNeutralino2TransverseMass->Write();
  TH1D *hSquarkTransverseMass = (TH1D*)fOutput->FindObject("hSquarkTransverseMass")->Clone();
  hSquarkTransverseMass->Write();
  TH1D *hGluinoTransverseMass = (TH1D*)fOutput->FindObject("hGluinoTransverseMass")->Clone();
  hGluinoTransverseMass->Write();
	
  TH1D *hMassCloseZLeptons = (TH1D*)fOutput->FindObject("hMassCloseZLeptons")->Clone();
  hMassCloseZLeptons->Write();
  TH1D *hMassCloseZMuons = (TH1D*)fOutput->FindObject("hMassCloseZMuons")->Clone();
  hMassCloseZMuons->Write();
  ...
  // TRIGGER STUDIES
  //  TH1D *h_EF_mu22_medium = (TH1D*)fOutput->FindObject("h_EF_mu22_medium")->Clone();
  //  h_EF_mu22_medium->Write();
  TH1D *h_EF_mu18_medium = (TH1D*)fOutput->FindObject("h_EF_mu18_medium")->Clone();
  h_EF_mu18_medium->Write();
//  TH1D *h_EF_2mu10_loose = (TH1D*)fOutput->FindObject("h_EF_2mu10_loose")->Clone();
//  h_EF_2mu10_loose->Write();
//  TH1D *h_EF_mu40_slow = (TH1D*)fOutput->FindObject("h_EF_mu40_slow")->Clone();
//  h_EF_mu40_slow->Write();
//  TH1D *h_EF_mu40_slow_medium = (TH1D*)fOutput->FindObject("h_EF_mu40_slow_medium")->Clone();
//  h_EF_mu40_slow_medium->Write();
//  TH1D *h_EF_mu40_slow_outOfTime_medium = (TH1D*)fOutput->FindObject("h_EF_mu40_slow_outOfTime_medium")->Clone();
//  h_EF_mu40_slow_outOfTime_medium->Write();
//  TH1D *h_EF_mu40_slow_empty = (TH1D*)fOutput->FindObject("h_EF_mu40_slow_empty")->Clone();
//  h_EF_mu40_slow_empty->Write();
//  TH1D *h_EF_mu40_slow_outOfTime = (TH1D*)fOutput->FindObject("h_EF_mu40_slow_outOfTime")->Clone();
//  h_EF_mu40_slow_outOfTime->Write();
  TH1D *h_trigger_muOR = (TH1D*)fOutput->FindObject("h_trigger_muOR")->Clone();
  h_trigger_muOR->Write();
  TH1D *h_trigger_muOR_BC = (TH1D*)fOutput->FindObject("h_trigger_muOR_BC")->Clone();
  h_trigger_muOR_BC->Write();
  ...
  TH2D *hHtJet1Jet2_HtLepton1Lepton2 = (TH2D*)fOutput->FindObject("hHtJet1Jet2_HtLepton1Lepton2")->Clone();
  hHtJet1Jet2_HtLepton1Lepton2->Write();
  TH2D *hHtJet1Jet2_Met = (TH2D*)fOutput->FindObject("hHtJet1Jet2_Met")->Clone();
  hHtJet1Jet2_Met->Write();
  TH2D *hHtJet1Jet2_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hHtJet1Jet2_LowBetaMuonBeta")->Clone();
  hHtJet1Jet2_LowBetaMuonBeta->Write();
  TH2D *hHtJet1Jet2_NJets = (TH2D*)fOutput->FindObject("hHtJet1Jet2_NJets")->Clone();
  hHtJet1Jet2_NJets->Write();
  TH2D *hHtJet1Jet2_NLeptons = (TH2D*)fOutput->FindObject("hHtJet1Jet2_NLeptons")->Clone();
  hHtJet1Jet2_NLeptons->Write();
  TH2D *hHtJet1Jet2_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hHtJet1Jet2_LowBetaMuon1Eta")->Clone();
  hHtJet1Jet2_LowBetaMuon1Eta->Write();
  TH2D *hHtJet1Jet2_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hHtJet1Jet2_LowBetaMuon1pT")->Clone();
  hHtJet1Jet2_LowBetaMuon1pT->Write();
  TH2D *hHtJet1Jet2_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hHtJet1Jet2_LowBetaMuon1MassBeta")->Clone();
  hHtJet1Jet2_LowBetaMuon1MassBeta->Write();
  TH2D *hHtJet1Jet2_GluinoMass = (TH2D*)fOutput->FindObject("hHtJet1Jet2_GluinoMass")->Clone();
  hHtJet1Jet2_GluinoMass->Write();
  TH2D *hHtLepton1Lepton2_Met = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_Met")->Clone();
  hHtLepton1Lepton2_Met->Write();
  TH2D *hHtLepton1Lepton2_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_LowBetaMuonBeta")->Clone();
  hHtLepton1Lepton2_LowBetaMuonBeta->Write();
  TH2D *hHtLepton1Lepton2_NJets = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_NJets")->Clone();
  hHtLepton1Lepton2_NJets->Write();
  TH2D *hHtLepton1Lepton2_NLeptons = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_NLeptons")->Clone();
  hHtLepton1Lepton2_NLeptons->Write();
  TH2D *hHtLepton1Lepton2_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_LowBetaMuon1Eta")->Clone();
  hHtLepton1Lepton2_LowBetaMuon1Eta->Write();
  TH2D *hHtLepton1Lepton2_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_LowBetaMuon1pT")->Clone();
  hHtLepton1Lepton2_LowBetaMuon1pT->Write();
  TH2D *hHtLepton1Lepton2_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_LowBetaMuon1MassBeta")->Clone();
  hHtLepton1Lepton2_LowBetaMuon1MassBeta->Write();
  TH2D *hHtLepton1Lepton2_GluinoMass = (TH2D*)fOutput->FindObject("hHtLepton1Lepton2_GluinoMass")->Clone();
  hHtLepton1Lepton2_GluinoMass->Write();
  TH2D *hHtAllJets_Met = (TH2D*)fOutput->FindObject("hHtAllJets_Met")->Clone();
  hHtAllJets_Met->Write();
  TH2D *hHtAllJets_HtAllLeptons = (TH2D*)fOutput->FindObject("hHtAllJets_HtAllLeptons")->Clone();
  hHtAllJets_HtAllLeptons->Write();
  TH2D *hHtAllJets_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hHtAllJets_LowBetaMuonBeta")->Clone();
  hHtAllJets_LowBetaMuonBeta->Write();
  TH2D *hHtAllJets_NJets = (TH2D*)fOutput->FindObject("hHtAllJets_NJets")->Clone();
  hHtAllJets_NJets->Write();
  TH2D *hHtAllJets_NLeptons = (TH2D*)fOutput->FindObject("hHtAllJets_NLeptons")->Clone();
  hHtAllJets_NLeptons->Write();
  TH2D *hHtAllJets_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hHtAllJets_LowBetaMuon1Eta")->Clone();
  hHtAllJets_LowBetaMuon1Eta->Write();
  TH2D *hHtAllJets_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hHtAllJets_LowBetaMuon1pT")->Clone();
  hHtAllJets_LowBetaMuon1pT->Write();
  TH2D *hHtAllJets_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hHtAllJets_LowBetaMuon1MassBeta")->Clone();
  hHtAllJets_LowBetaMuon1MassBeta->Write();
  TH2D *hHtAllJets_GluinoMass = (TH2D*)fOutput->FindObject("hHtAllJets_GluinoMass")->Clone();
  hHtAllJets_GluinoMass->Write();
  TH2D *hHtAllLeptons_Met = (TH2D*)fOutput->FindObject("hHtAllLeptons_Met")->Clone();
  hHtAllLeptons_Met->Write();
  TH2D *hHtAllLeptons_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hHtAllLeptons_LowBetaMuonBeta")->Clone();
  hHtAllLeptons_LowBetaMuonBeta->Write();
  TH2D *hHtAllLeptons_NJets = (TH2D*)fOutput->FindObject("hHtAllLeptons_NJets")->Clone();
  hHtAllLeptons_NJets->Write();
  TH2D *hHtAllLeptons_NLeptons = (TH2D*)fOutput->FindObject("hHtAllLeptons_NLeptons")->Clone();
  hHtAllLeptons_NLeptons->Write();
  TH2D *hHtAllLeptons_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hHtAllLeptons_LowBetaMuon1Eta")->Clone();
  hHtAllLeptons_LowBetaMuon1Eta->Write();
  TH2D *hHtAllLeptons_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hHtAllLeptons_LowBetaMuon1pT")->Clone();
  hHtAllLeptons_LowBetaMuon1pT->Write();
  TH2D *hHtAllLeptons_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hHtAllLeptons_LowBetaMuon1MassBeta")->Clone();
  hHtAllLeptons_LowBetaMuon1MassBeta->Write();
  TH2D *hHtAllLeptons_GluinoMass = (TH2D*)fOutput->FindObject("hHtAllLeptons_GluinoMass")->Clone();
  hHtAllLeptons_GluinoMass->Write();
  TH2D *hHtAllJetsAllLeptons_Met = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_Met")->Clone();
  hHtAllJetsAllLeptons_Met->Write();
  TH2D *hHtAllJetsAllLeptons_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_LowBetaMuonBeta")->Clone();
  hHtAllJetsAllLeptons_LowBetaMuonBeta->Write();
  TH2D *hHtAllJetsAllLeptons_NJets = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_NJets")->Clone();
  hHtAllJetsAllLeptons_NJets->Write();
  TH2D *hHtAllJetsAllLeptons_NLeptons = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_NLeptons")->Clone();
  hHtAllJetsAllLeptons_NLeptons->Write();
  TH2D *hHtAllJetsAllLeptons_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_LowBetaMuon1Eta")->Clone();
  hHtAllJetsAllLeptons_LowBetaMuon1Eta->Write();
  TH2D *hHtAllJetsAllLeptons_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_LowBetaMuon1pT")->Clone();
  hHtAllJetsAllLeptons_LowBetaMuon1pT->Write();
  TH2D *hHtAllJetsAllLeptons_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_LowBetaMuon1MassBeta")->Clone();
  hHtAllJetsAllLeptons_LowBetaMuon1MassBeta->Write();
  TH2D *hHtAllJetsAllLeptons_GluinoMass = (TH2D*)fOutput->FindObject("hHtAllJetsAllLeptons_GluinoMass")->Clone();
  hHtAllJetsAllLeptons_GluinoMass->Write();



  TH2D * hJet1Pt_Met = (TH2D*)fOutput->FindObject("hJet1Pt_Met")->Clone();
  hJet1Pt_Met->Write();
  TH2D * hJet1Pt_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hJet1Pt_LowBetaMuonBeta")->Clone();
  hJet1Pt_LowBetaMuonBeta->Write();
  TH2D * hJet1Pt_NJets = (TH2D*)fOutput->FindObject("hJet1Pt_NJets")->Clone();
  hJet1Pt_NJets->Write();
  TH2D * hJet1Pt_NLeptons = (TH2D*)fOutput->FindObject("hJet1Pt_NLeptons")->Clone();
  hJet1Pt_NLeptons->Write();
  TH2D * hJet1Pt_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hJet1Pt_LowBetaMuon1Eta")->Clone();
  hJet1Pt_LowBetaMuon1Eta->Write();
  TH2D * hJet1Pt_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hJet1Pt_LowBetaMuon1pT")->Clone();
  hJet1Pt_LowBetaMuon1pT->Write();
  TH2D * hJet1Pt_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hJet1Pt_LowBetaMuon1MassBeta")->Clone();
  hJet1Pt_LowBetaMuon1MassBeta->Write();
  TH2D * hJet1Pt_GluinoMass = (TH2D*)fOutput->FindObject("hJet1Pt_GluinoMass")->Clone();
  hJet1Pt_GluinoMass->Write();
  TH2D * hMet_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hMet_LowBetaMuonBeta")->Clone();
  hMet_LowBetaMuonBeta->Write();
  TH2D * hMet_NJets = (TH2D*)fOutput->FindObject("hMet_NJets")->Clone();
  hMet_NJets->Write();
  TH2D * hMet_NLeptons = (TH2D*)fOutput->FindObject("hMet_NLeptons")->Clone();
  hMet_NLeptons->Write();
  TH2D * hMet_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hMet_LowBetaMuon1Eta")->Clone();
  hMet_LowBetaMuon1Eta->Write();
  TH2D * hMet_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hMet_LowBetaMuon1pT")->Clone();
  hMet_LowBetaMuon1pT->Write();
  TH2D * hMet_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hMet_LowBetaMuon1MassBeta")->Clone();
  hMet_LowBetaMuon1MassBeta->Write();
  TH2D * hMet_GluinoMass = (TH2D*)fOutput->FindObject("hMet_GluinoMass")->Clone();
  hMet_GluinoMass->Write();
  TH2D * hLowBetaMuonBeta_NJets = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_NJets")->Clone();
  hLowBetaMuonBeta_NJets->Write();
  TH2D * hLowBetaMuonBeta_NLeptons = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_NLeptons")->Clone();
  hLowBetaMuonBeta_NLeptons->Write();
  TH2D * hLowBetaMuonBeta_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_LowBetaMuon1Eta")->Clone();
  hLowBetaMuonBeta_LowBetaMuon1Eta->Write();
  TH2D * hLowBetaMuonBeta_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_LowBetaMuon1pT")->Clone();
  hLowBetaMuonBeta_LowBetaMuon1pT->Write();
  TH2D * hLowBetaMuonBeta_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_LowBetaMuon1MassBeta")->Clone();
  hLowBetaMuonBeta_LowBetaMuon1MassBeta->Write();
  TH2D * hLowBetaMuonBeta_GluinoMass = (TH2D*)fOutput->FindObject("hLowBetaMuonBeta_GluinoMass")->Clone();
  hLowBetaMuonBeta_GluinoMass->Write();
  TH2D * hNJets_NLeptons = (TH2D*)fOutput->FindObject("hNJets_NLeptons")->Clone();
  hNJets_NLeptons->Write();
  TH2D * hNJets_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hNJets_LowBetaMuon1Eta")->Clone();
  hNJets_LowBetaMuon1Eta->Write();
  TH2D * hNJets_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hNJets_LowBetaMuon1pT")->Clone();
  hNJets_LowBetaMuon1pT->Write();
  TH2D * hNJets_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hNJets_LowBetaMuon1MassBeta")->Clone();
  hNJets_LowBetaMuon1MassBeta->Write();
  TH2D * hNJets_GluinoMass = (TH2D*)fOutput->FindObject("hNJets_GluinoMass")->Clone();
  hNJets_GluinoMass->Write();
  TH2D * hNLeptons_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hNLeptons_LowBetaMuon1Eta")->Clone();
  hNLeptons_LowBetaMuon1Eta->Write();
  TH2D * hNLeptons_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hNLeptons_LowBetaMuon1pT")->Clone();
  hNLeptons_LowBetaMuon1pT->Write();
  TH2D * hNLeptons_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hNLeptons_LowBetaMuon1MassBeta")->Clone();
  hNLeptons_LowBetaMuon1MassBeta->Write();
  TH2D * hNLeptons_GluinoMass = (TH2D*)fOutput->FindObject("hNLeptons_GluinoMass")->Clone();
  hNLeptons_GluinoMass->Write();
  TH2D * hLowBetaMuon1Eta_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hLowBetaMuon1Eta_LowBetaMuon1pT")->Clone();
  hLowBetaMuon1Eta_LowBetaMuon1pT->Write();
  TH2D * hLowBetaMuon1Eta_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hLowBetaMuon1Eta_LowBetaMuon1MassBeta")->Clone();
  hLowBetaMuon1Eta_LowBetaMuon1MassBeta->Write();
  TH2D * hLowBetaMuon1Eta_GluinoMass = (TH2D*)fOutput->FindObject("hLowBetaMuon1Eta_GluinoMass")->Clone();
  hLowBetaMuon1Eta_GluinoMass->Write();
  TH2D * hLowBetaMuon1pT_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hLowBetaMuon1pT_LowBetaMuon1MassBeta")->Clone();
  hLowBetaMuon1pT_LowBetaMuon1MassBeta->Write();
  TH2D * hLowBetaMuon1pT_GluinoMass = (TH2D*)fOutput->FindObject("hLowBetaMuon1pT_GluinoMass")->Clone();
  hLowBetaMuon1pT_GluinoMass->Write();
  TH2D * hLowBetaMuon1MassBeta_GluinoMass = (TH2D*)fOutput->FindObject("hLowBetaMuon1MassBeta_GluinoMass")->Clone();
  hLowBetaMuon1MassBeta_GluinoMass->Write();

  TH2D *hMassCloseZMuons_HtAllJetsAllLeptons = (TH2D*)fOutput->FindObject("hMassCloseZMuons_HtAllJetsAllLeptons")->Clone();
  hMassCloseZMuons_HtAllJetsAllLeptons->Write();
  TH2D *hMassCloseZMuons_HtAllJets = (TH2D*)fOutput->FindObject("hMassCloseZMuons_HtAllJets")->Clone();
  hMassCloseZMuons_HtAllJets->Write();
  TH2D *hMassCloseZMuons_HtAllLeptons = (TH2D*)fOutput->FindObject("hMassCloseZMuons_HtAllLeptons")->Clone();
  hMassCloseZMuons_HtAllLeptons->Write();
  TH2D *hMassCloseZMuons_Met = (TH2D*)fOutput->FindObject("hMassCloseZMuons_Met")->Clone();
  hMassCloseZMuons_Met->Write();
  TH2D *hMassCloseZMuons_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hMassCloseZMuons_LowBetaMuonBeta")->Clone();
  hMassCloseZMuons_LowBetaMuonBeta->Write();
  TH2D *hMassCloseZMuons_NJets = (TH2D*)fOutput->FindObject("hMassCloseZMuons_NJets")->Clone();
  hMassCloseZMuons_NJets->Write();
  TH2D *hMassCloseZMuons_NLeptons = (TH2D*)fOutput->FindObject("hMassCloseZMuons_NLeptons")->Clone();
  hMassCloseZMuons_NLeptons->Write();
  TH2D *hMassCloseZMuons_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hMassCloseZMuons_LowBetaMuon1Eta")->Clone();
  hMassCloseZMuons_LowBetaMuon1Eta->Write();
  TH2D *hMassCloseZMuons_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hMassCloseZMuons_LowBetaMuon1pT")->Clone();
  hMassCloseZMuons_LowBetaMuon1pT->Write();
  TH2D *hMassCloseZMuons_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hMassCloseZMuons_LowBetaMuon1MassBeta")->Clone();
  hMassCloseZMuons_LowBetaMuon1MassBeta->Write();
  TH2D *hMassCloseZMuons_GluinoMass = (TH2D*)fOutput->FindObject("hMassCloseZMuons_GluinoMass")->Clone();
  hMassCloseZMuons_GluinoMass->Write();

  TH2D *hRequireNeutralino_HtAllJetsAllLeptons = (TH2D*)fOutput->FindObject("hRequireNeutralino_HtAllJetsAllLeptons")->Clone();
  hRequireNeutralino_HtAllJetsAllLeptons->Write();
  TH2D *hRequireNeutralino_HtAllJets = (TH2D*)fOutput->FindObject("hRequireNeutralino_HtAllJets")->Clone();
  hRequireNeutralino_HtAllJets->Write();
  TH2D *hRequireNeutralino_HtAllLeptons = (TH2D*)fOutput->FindObject("hRequireNeutralino_HtAllLeptons")->Clone();
  hRequireNeutralino_HtAllLeptons->Write();
  TH2D *hRequireNeutralino_Met = (TH2D*)fOutput->FindObject("hRequireNeutralino_Met")->Clone();
  hRequireNeutralino_Met->Write();
  TH2D *hRequireNeutralino_LowBetaMuonBeta = (TH2D*)fOutput->FindObject("hRequireNeutralino_LowBetaMuonBeta")->Clone();
  hRequireNeutralino_LowBetaMuonBeta->Write();
  TH2D *hRequireNeutralino_NJets = (TH2D*)fOutput->FindObject("hRequireNeutralino_NJets")->Clone();
  hRequireNeutralino_NJets->Write();
  TH2D *hRequireNeutralino_NLeptons = (TH2D*)fOutput->FindObject("hRequireNeutralino_NLeptons")->Clone();
  hRequireNeutralino_NLeptons->Write();
  TH2D *hRequireNeutralino_LowBetaMuon1Eta = (TH2D*)fOutput->FindObject("hRequireNeutralino_LowBetaMuon1Eta")->Clone();
  hRequireNeutralino_LowBetaMuon1Eta->Write();
  TH2D *hRequireNeutralino_LowBetaMuon1pT = (TH2D*)fOutput->FindObject("hRequireNeutralino_LowBetaMuon1pT")->Clone();
  hRequireNeutralino_LowBetaMuon1pT->Write();
  TH2D *hRequireNeutralino_LowBetaMuon1MassBeta = (TH2D*)fOutput->FindObject("hRequireNeutralino_LowBetaMuon1MassBeta")->Clone();
  hRequireNeutralino_LowBetaMuon1MassBeta->Write();
  TH2D *hRequireNeutralino_GluinoMass = (TH2D*)fOutput->FindObject("hRequireNeutralino_GluinoMass")->Clone();
  hRequireNeutralino_GluinoMass->Write();
  TH2D *hRequireNeutralino_MassCloseZMuons = (TH2D*)fOutput->FindObject("hRequireNeutralino_MassCloseZMuons")->Clone();
  hRequireNeutralino_MassCloseZMuons->Write();


	
  TH1D *BarCodeHistoMuon = (TH1D*)fOutput->FindObject("BarCodeHistoMuon")->Clone();
  BarCodeHistoMuon->Write();
...
Float_t Analysis::findMCmass( Int_t p_barcode){
  unsigned int mc_n = m_sel->GetScalarVal<Int_t>("mc_n");
  std::vector< int > mc_barcode = m_sel->GetRawVector< std::vector<int> >("mc_barcode");
  std::vector< float > mc_m = m_sel->GetRawVector< std::vector<float> >("mc_m");
  for (unsigned int j = 0 ; j < mc_n ; j++) {
...
Bool_t Analysis::hasTruthBarcode( std::vector<int> myvector, int element ){
  for ( unsigned int i = 0; i < myvector.size(); i++){
    if (myvector.at(i)==element){
      return true;
    }
  }
  return false;
...
int Analysis::hasTruthDuplicates( std::vector<int> myvector, int element ){
